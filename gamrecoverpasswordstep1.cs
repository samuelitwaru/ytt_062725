...
namespace GeneXus.Programs {
   public class gamrecoverpasswordstep1 : GXDataArea
   {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV24GXV1 = 1;
         while ( AV24GXV1 <= AV6Errors.Count )
         {
            AV22Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV6Errors.Item(AV24GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256277374989", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamrecoverpasswordstep1.js", "?20256277374992", false, true);
