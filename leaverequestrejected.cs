...
namespace GeneXus.Programs {
   public class leaverequestrejected : GXWebComponent
   {
      ...
      protected void RF3B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               ...
               A171LeaveRequestHalfDay = H003B2_A171LeaveRequestHalfDay[0];
               n171LeaveRequestHalfDay = H003B2_n171LeaveRequestHalfDay[0];
      ...
      protected void E173B2( )
      {
         ...
         {
            A162ProjectManagerId = H003B4_A162ProjectManagerId[0];
            n162ProjectManagerId = H003B4_n162ProjectManagerId[0];
      ...
      protected void E183B2( )
      {
         ...
         edtavLeaverequestrejectionreasonvariable_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV23ColumnsSelector.gxTpr_Columns.Item(8)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtEmployeeBalance_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV23ColumnsSelector.gxTpr_Columns.Item(9)).gxTpr_Isvisible ? 1 : 0);
      ...
      protected void E163B2( )
      {
         ...
         new WorkWithPlus.workwithplus_web.savecolumnsselectorstate(context ).execute(  "LeaveRequestRejectedColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV21ColumnsSelectorXML)) ? "" : AV23ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E113B2( )
      {
         ...
         else
         {
            ...
            new WorkWithPlus.workwithplus_web.getfilterbyname(context ).execute(  "LeaveRequestRejectedFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
            ...
            else
            {
               ...
               new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV77Pgmname+"GridState",  AV27ManageFiltersXml) ;
      ...
      protected void S172( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV23ColumnsSelector,  "&LeaveRequestRejectionReasonVariable",  "",  "Rejection Reason",  true,  "") ;
         ...
         new WorkWithPlus.workwithplus_web.loadcolumnsselectorstate(context ).execute(  "LeaveRequestRejectedColumnsSelector", out  GXt_char3) ;
      ...
      protected void S122( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_managefiltersloadsavedfilters(context ).execute(  "LeaveRequestRejectedFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S142( )
      {
         ...
         {
            AV13GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  AV77Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S192( )
      {
         ...
         {
            AV14GridStateFilterValue = ((WorkWithPlus.workwithplus_web.SdtWWPGridState_FilterValue)AV13GridState.gxTpr_Filtervalues.Item(AV94GXV1));
         ...
         GXt_char3 = "";
         new WorkWithPlus.workwithplus_web.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV30TFEmployeeName_Sel)),  AV30TFEmployeeName_Sel, out  GXt_char3) ;
         GXt_char5 = "";
         ...
         GXt_char6 = "";
         new WorkWithPlus.workwithplus_web.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV66TFLeaveRequestHalfDay_Sel)),  AV66TFLeaveRequestHalfDay_Sel, out  GXt_char6) ;
         ...
         GXt_char3 = "";
         new WorkWithPlus.workwithplus_web.wwp_getfilterval(context ).execute(  !(0==AV67TFLeaveRequestHalfDayOperator)||String.IsNullOrEmpty(StringUtil.RTrim( AV65TFLeaveRequestHalfDay)),  AV65TFLeaveRequestHalfDay, out  GXt_char3) ;
      ...
      protected void S162( )
      {
         ...
         new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV77Pgmname+"GridState",  AV13GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void S112( )
      {
         ...
         {
            A162ProjectManagerId = H003B5_A162ProjectManagerId[0];
            n162ProjectManagerId = H003B5_n162ProjectManagerId[0];
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202582617151272", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("leaverequestrejected.js", "?202582617151273", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E193B2","iparms":[{"av":"A133LeaveRequestDescription","fld":"LEAVEREQUESTDESCRIPTION"},{"av":"A134LeaveRequestRejectionReason","fld":"LEAVEREQUESTREJECTIONREASON"},{"av":"A171LeaveRequestHalfDay","fld":"LEAVEREQUESTHALFDAY"}]""");
      ...
      public override void initialize( )
      {
         ...
         H003B2_A171LeaveRequestHalfDay = new string[] {""} ;
         H003B2_n171LeaveRequestHalfDay = new bool[] {false} ;
         ...
         H003B4_A162ProjectManagerId = new long[1] ;
         H003B4_n162ProjectManagerId = new bool[] {false} ;
         ...
         AV19ExcelFilename = "";
         AV20ErrorMessage = "";
         H003B5_A162ProjectManagerId = new long[1] ;
         H003B5_n162ProjectManagerId = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.leaverequestrejected__default(),
            new Object[][] {
                new Object[] {
               H003B2_A100CompanyId, H003B2_A147EmployeeBalance, H003B2_A106EmployeeId, H003B2_A134LeaveRequestRejectionReason, H003B2_A133LeaveRequestDescription, H003B2_A132LeaveRequestStatus, H003B2_A131LeaveRequestDuration, H003B2_A171LeaveRequestHalfDay, H003B2_n171LeaveRequestHalfDay, H003B2_A130LeaveRequestEndDate,
               ...
               , new Object[] {
               H003B4_A162ProjectManagerId, H003B4_n162ProjectManagerId, H003B4_A102ProjectId
               }
               , new Object[] {
               H003B5_A162ProjectManagerId, H003B5_n162ProjectManagerId, H003B5_A102ProjectId
               }
            }
         );
         AV77Pgmname = "LeaveRequestRejected";
      ...
      private string[] H003B2_A171LeaveRequestHalfDay ;
      private bool[] H003B2_n171LeaveRequestHalfDay ;
      ...
      private long[] H003B4_A162ProjectManagerId ;
      private bool[] H003B4_n162ProjectManagerId ;
      ...
      private long[] H003B5_A162ProjectManagerId ;
      private bool[] H003B5_n162ProjectManagerId ;
