...
namespace GeneXus.Programs {
   public class gamexamplechangepassword : GXHttpHandler
   {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV42GXV1 = 1;
         while ( AV42GXV1 <= AV38GAMErrorCollection.Count )
         {
            AV40GAMError = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV38GAMErrorCollection.Item(AV42GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025624196288", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexamplechangepassword.js", "?2025624196291", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
