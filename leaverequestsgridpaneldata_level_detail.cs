...
namespace GeneXus.Programs {
   public class leaverequestsgridpaneldata_level_detail : GXDataGridProcedure
   {
      ...
      {
         get {
            return "leaverequestsgridpaneldata_Execute" ;
         }

      }

      public leaverequestsgridpaneldata_level_detail( )
      {
      ...
      public leaverequestsgridpaneldata_level_detail( IGxContext context )
      {
      ...
      public void execute( string aP0_TrnMode ,
                           ...
                           int aP3_gxid ,
                           out SdtLeaveRequestsGridPanelData_Level_DetailSdt aP4_GXM1LeaveRequestsGridPanelData_Level_DetailSdt )
      {
         ...
         this.AV22GXM1LeaveRequestsGridPanelData_Level_DetailSdt = new SdtLeaveRequestsGridPanelData_Level_DetailSdt(context) ;
         initialize();
         ExecuteImpl();
         aP4_GXM1LeaveRequestsGridPanelData_Level_DetailSdt=this.AV22GXM1LeaveRequestsGridPanelData_Level_DetailSdt;
      }

      public SdtLeaveRequestsGridPanelData_Level_DetailSdt executeUdp( string aP0_TrnMode ,
                                                                       long aP1_LeaveRequestId ,
                                                                       string aP2_TrnContextJson ,
                                                                       int aP3_gxid )
      {
         execute(aP0_TrnMode, aP1_LeaveRequestId, aP2_TrnContextJson, aP3_gxid, out aP4_GXM1LeaveRequestsGridPanelData_Level_DetailSdt);
         return AV22GXM1LeaveRequestsGridPanelData_Level_DetailSdt ;
      }
      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( StringUtil.StrCmp(Gxwebsession.Get(Gxids), "") == 0 )
         {
            ...
            if ( ( ( StringUtil.StrCmp(AV11TrnMode, "DSP") == 0 ) ) || ( ( StringUtil.StrCmp(AV11TrnMode, "INS") == 0 ) && new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context).executeUdp(  "leaverequestsgridpaneldata_Insert") ) || ( ( StringUtil.StrCmp(AV11TrnMode, "UPD") == 0 ) && new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context).executeUdp(  "leaverequestsgridpaneldata_Update") ) || ( ( StringUtil.StrCmp(AV11TrnMode, "DLT") == 0 ) && new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context).executeUdp(  "leaverequestsgridpaneldata_Delete") ) )
            {
         ...
         AV22GXM1LeaveRequestsGridPanelData_Level_DetailSdt.gxTpr_Leaverequest = AV7LeaveRequest;
         AV22GXM1LeaveRequestsGridPanelData_Level_DetailSdt.gxTpr_Trnmode = AV11TrnMode;
         AV22GXM1LeaveRequestsGridPanelData_Level_DetailSdt.gxTpr_Leaverequestid = AV15LeaveRequestId;
         AV22GXM1LeaveRequestsGridPanelData_Level_DetailSdt.gxTpr_Messages = AV6Messages;
         AV22GXM1LeaveRequestsGridPanelData_Level_DetailSdt.gxTpr_Gxdynprop = "[ "+Gxdynprop+" ]";
         Gxdynprop = "";
         cleanup();
      }
      ...
      {
         AV22GXM1LeaveRequestsGridPanelData_Level_DetailSdt = new SdtLeaveRequestsGridPanelData_Level_DetailSdt(context);
         Gxids = "";
      ...
      private SdtLeaveRequestsGridPanelData_Level_DetailSdt AV22GXM1LeaveRequestsGridPanelData_Level_DetailSdt ;
      ...
      private SdtLeaveRequestsGridPanelData_Level_DetailSdt aP4_GXM1LeaveRequestsGridPanelData_Level_DetailSdt ;
   }
