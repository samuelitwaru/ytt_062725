   ...
   public class employeevacationsetwc : GXWebComponent
   {
      ...
      protected void RF5G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A106EmployeeId = H005G2_A106EmployeeId[0];
               AssignAttri(sPrefix, false, "A106EmployeeId", StringUtil.LTrimStr( (decimal)(A106EmployeeId), 10, 0));
               A179VacationSetDays = H005G2_A179VacationSetDays[0];
               A186VacationSetDate = H005G2_A186VacationSetDate[0];
               /* Execute user event: Grid.Load */
               E165G2 ();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256275222643", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("employeevacationsetwc.js", "?20256275222644", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_152( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtVacationSetDays_Internalname,StringUtil.LTrim( StringUtil.NToC( A179VacationSetDays, 4, 1, ".", "")),StringUtil.LTrim( context.localUtil.Format( A179VacationSetDays, "Z9.9")),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtVacationSetDays_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)15,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
      ...
      protected void StartGridControl15( )
      {
         ...
         else
         {
            ...
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( A179VacationSetDays, 4, 1, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E165G2","iparms":[]}""");
      ...
      public override void initialize( )
      {
         ...
         H005G2_A106EmployeeId = new long[1] ;
         H005G2_A179VacationSetDays = new decimal[1] ;
         H005G2_A186VacationSetDate = new DateTime[] {DateTime.MinValue} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.employeevacationsetwc__default(),
            new Object[][] {
                new Object[] {
               H005G2_A106EmployeeId, H005G2_A179VacationSetDays, H005G2_A186VacationSetDate
               }
               , new Object[] {
      ...
      private long[] H005G2_A106EmployeeId ;
      private decimal[] H005G2_A179VacationSetDays ;
      private DateTime[] H005G2_A186VacationSetDate ;
