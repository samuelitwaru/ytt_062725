...
namespace GeneXus.Programs {
   public class gamrecoverpasswordstep2 : GXDataArea
   {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV29GXV1 = 1;
         while ( AV29GXV1 <= AV27Errors.Count )
         {
            AV26Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV27Errors.Item(AV29GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202572513524734", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamrecoverpasswordstep2.js", "?202572513524737", false, true);
