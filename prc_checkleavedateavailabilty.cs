   ...
   public class prc_checkleavedateavailabilty : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A171LeaveRequestHalfDay = P00C22_A171LeaveRequestHalfDay[0];
            n171LeaveRequestHalfDay = P00C22_n171LeaveRequestHalfDay[0];
            A127LeaveRequestId = P00C22_A127LeaveRequestId[0];
            A144LeaveTypeVacationLeave = P00C22_A144LeaveTypeVacationLeave[0];
            AV14GXLvl3 = 1;
            AV10IsAvailable = false;
            if ( ( StringUtil.StrCmp(A171LeaveRequestHalfDay, AV13LeaveRequestHalfDay) == 0 ) && ( DateTimeUtil.ResetTime ( A129LeaveRequestStartDate ) == DateTimeUtil.ResetTime ( AV8StartDate ) ) && ( DateTimeUtil.ResetTime ( A130LeaveRequestEndDate ) == DateTimeUtil.ResetTime ( AV9EndDate ) ) )
            {
               AV10IsAvailable = false;
            }
            else
      ...
      public override void initialize( )
      {
         ...
         P00C22_A171LeaveRequestHalfDay = new string[] {""} ;
         P00C22_n171LeaveRequestHalfDay = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_checkleavedateavailabilty__default(),
            new Object[][] {
                new Object[] {
               P00C22_A124LeaveTypeId, P00C22_A144LeaveTypeVacationLeave, P00C22_A129LeaveRequestStartDate, P00C22_A130LeaveRequestEndDate, P00C22_A106EmployeeId, P00C22_A171LeaveRequestHalfDay, P00C22_n171LeaveRequestHalfDay, P00C22_A127LeaveRequestId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00C22_A171LeaveRequestHalfDay ;
      private bool[] P00C22_n171LeaveRequestHalfDay ;
