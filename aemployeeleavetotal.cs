   ...
   public class aemployeeleavetotal : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(2) != 101) )
         {
            ...
            if ( ( DateTimeUtil.ResetTime ( A129LeaveRequestStartDate ) >= DateTimeUtil.ResetTime ( AV12LeaveStartDate ) ) && ( DateTimeUtil.ResetTime ( A130LeaveRequestEndDate ) <= DateTimeUtil.ResetTime ( AV13LeaveEndDate ) ) )
            {
            ...
            {
               A157CompanyLocationId = P009Y5_A157CompanyLocationId[0];
               A115HolidayStartDate = P009Y5_A115HolidayStartDate[0];
               A113HolidayId = P009Y5_A113HolidayId[0];
               A157CompanyLocationId = P009Y5_A157CompanyLocationId[0];
               AV14Duration = (decimal)(AV14Duration+1);
               new logtofile(context ).execute(  "			adding holiday: 1") ;
         ...
         if ( AV26GXLvl30 == 0 )
         {
            ...
            new logtofile(context ).execute(  "			adding holidaycount none: "+StringUtil.Str( (decimal)(AV15HolidayCount), 4, 0)) ;
         }
      ...
      public override void initialize( )
      {
         ...
         P009Y5_A100CompanyId = new long[1] ;
         P009Y5_A157CompanyLocationId = new long[1] ;
         P009Y5_A115HolidayStartDate = new DateTime[] {DateTime.MinValue} ;
         P009Y5_A113HolidayId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aemployeeleavetotal__default(),
            new Object[][] {
               ...
               , new Object[] {
               P009Y4_A124LeaveTypeId, P009Y4_A100CompanyId, P009Y4_A130LeaveRequestEndDate, P009Y4_A129LeaveRequestStartDate, P009Y4_A132LeaveRequestStatus, P009Y4_A145LeaveTypeLoggingWorkHours, P009Y4_A106EmployeeId, P009Y4_A131LeaveRequestDuration, P009Y4_A127LeaveRequestId
               }
               , new Object[] {
               P009Y5_A100CompanyId, P009Y5_A157CompanyLocationId, P009Y5_A115HolidayStartDate, P009Y5_A113HolidayId
               }
               , new Object[] {
      ...
      private long[] P009Y5_A100CompanyId ;
      private long[] P009Y5_A157CompanyLocationId ;
      private DateTime[] P009Y5_A115HolidayStartDate ;
      private long[] P009Y5_A113HolidayId ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P009Y5", "SELECT T1.CompanyId, T2.CompanyLocationId, T1.HolidayStartDate, T1.HolidayId FROM (Holiday T1 INNER JOIN Company T2 ON T2.CompanyId = T1.CompanyId) WHERE (T1.CompanyId = :CompanyId) AND (( T1.HolidayStartDate >= :AV10FromDate and T1.HolidayStartDate <= :AV12LeaveStartDate) or ( T1.HolidayStartDate > :AV13LeaveEndDate and T1.HolidayStartDate < :AV11ToDate)) AND (T2.CompanyLocationId = :AV17CompanyLocationId) ORDER BY T1.CompanyId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP009Y5,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P009Y7", "SELECT COALESCE( T1.GXC1, 0) AS GXC1 FROM (SELECT COUNT(*) AS GXC1 FROM (Holiday T2 INNER JOIN Company T3 ON T3.CompanyId = T2.CompanyId) WHERE (T2.HolidayStartDate >= :AV10FromDate) AND (T2.HolidayStartDate <= :AV11ToDate) AND ((date_part('dow', CAST(T2.HolidayStartDate AS date)) + 1) > 1) AND ((date_part('dow', CAST(T2.HolidayStartDate AS date)) + 1) < 7) AND (T3.CompanyLocationId = :AV17CompanyLocationId) ) T1 ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP009Y7,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
