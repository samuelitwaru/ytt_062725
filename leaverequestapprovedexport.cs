...
namespace GeneXus.Programs {
   public class leaverequestapprovedexport : GXProcedure
   {
      ...
      protected void S141( )
      {
         ...
         {
            AV26ColumnsSelector_Column = ((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV24ColumnsSelector.gxTpr_Columns.Item(AV59GXV1));
      ...
      protected void S161( )
      {
         /* 'WRITEDATA' Routine */
         returnInSub = false;
         AV61Leaverequestapprovedds_1_filterfulltext = AV19FilterFullText;
         AV62Leaverequestapprovedds_2_tfemployeename = AV35TFEmployeeName;
         AV63Leaverequestapprovedds_3_tfemployeename_sel = AV36TFEmployeeName_Sel;
         AV64Leaverequestapprovedds_4_tfleavetypename = AV37TFLeaveTypeName;
         AV65Leaverequestapprovedds_5_tfleavetypename_sel = AV38TFLeaveTypeName_Sel;
         AV66Leaverequestapprovedds_6_tfleaverequeststartdate = AV41TFLeaveRequestStartDate;
         AV67Leaverequestapprovedds_7_tfleaverequeststartdate_to = AV42TFLeaveRequestStartDate_To;
         AV68Leaverequestapprovedds_8_tfleaverequestenddate = AV43TFLeaveRequestEndDate;
         AV69Leaverequestapprovedds_9_tfleaverequestenddate_to = AV44TFLeaveRequestEndDate_To;
         AV70Leaverequestapprovedds_10_tfleaverequesthalfday = AV51TFLeaveRequestHalfDay;
         AV71Leaverequestapprovedds_11_tfleaverequesthalfdayoperator = AV53TFLeaveRequestHalfDayOperator;
         AV72Leaverequestapprovedds_12_tfleaverequesthalfday_sel = AV52TFLeaveRequestHalfDay_Sel;
         AV73Leaverequestapprovedds_13_tfleaverequestduration = AV45TFLeaveRequestDuration;
         AV74Leaverequestapprovedds_14_tfleaverequestduration_to = AV46TFLeaveRequestDuration_To;
         AV75Udparg15 = new getloggedinusercompanyid(context).executeUdp( );
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              A106EmployeeId ,
                                              AV50EmployeeIds ,
                                              AV61Leaverequestapprovedds_1_filterfulltext ,
                                              AV63Leaverequestapprovedds_3_tfemployeename_sel ,
                                              AV62Leaverequestapprovedds_2_tfemployeename ,
                                              AV65Leaverequestapprovedds_5_tfleavetypename_sel ,
                                              AV64Leaverequestapprovedds_4_tfleavetypename ,
                                              AV66Leaverequestapprovedds_6_tfleaverequeststartdate ,
                                              AV67Leaverequestapprovedds_7_tfleaverequeststartdate_to ,
                                              AV68Leaverequestapprovedds_8_tfleaverequestenddate ,
                                              AV69Leaverequestapprovedds_9_tfleaverequestenddate_to ,
                                              AV72Leaverequestapprovedds_12_tfleaverequesthalfday_sel ,
                                              AV70Leaverequestapprovedds_10_tfleaverequesthalfday ,
                                              AV71Leaverequestapprovedds_11_tfleaverequesthalfdayoperator ,
                                              AV73Leaverequestapprovedds_13_tfleaverequestduration ,
                                              AV74Leaverequestapprovedds_14_tfleaverequestduration_to ,
                                              A148EmployeeName ,
                                              A125LeaveTypeName ,
         ...
         lV61Leaverequestapprovedds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV61Leaverequestapprovedds_1_filterfulltext), "%", "");
         lV61Leaverequestapprovedds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV61Leaverequestapprovedds_1_filterfulltext), "%", "");
         lV61Leaverequestapprovedds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV61Leaverequestapprovedds_1_filterfulltext), "%", "");
         lV61Leaverequestapprovedds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV61Leaverequestapprovedds_1_filterfulltext), "%", "");
         lV62Leaverequestapprovedds_2_tfemployeename = StringUtil.PadR( StringUtil.RTrim( AV62Leaverequestapprovedds_2_tfemployeename), 100, "%");
         lV64Leaverequestapprovedds_4_tfleavetypename = StringUtil.PadR( StringUtil.RTrim( AV64Leaverequestapprovedds_4_tfleavetypename), 100, "%");
         lV70Leaverequestapprovedds_10_tfleaverequesthalfday = StringUtil.PadR( StringUtil.RTrim( AV70Leaverequestapprovedds_10_tfleaverequesthalfday), 20, "%");
         /* Using cursor P006X2 */
         pr_default.execute(0, new Object[] {lV61Leaverequestapprovedds_1_filterfulltext, lV61Leaverequestapprovedds_1_filterfulltext, lV61Leaverequestapprovedds_1_filterfulltext, lV61Leaverequestapprovedds_1_filterfulltext, lV62Leaverequestapprovedds_2_tfemployeename, AV63Leaverequestapprovedds_3_tfemployeename_sel, lV64Leaverequestapprovedds_4_tfleavetypename, AV65Leaverequestapprovedds_5_tfleavetypename_sel, AV66Leaverequestapprovedds_6_tfleaverequeststartdate, AV67Leaverequestapprovedds_7_tfleaverequeststartdate_to, AV68Leaverequestapprovedds_8_tfleaverequestenddate, AV69Leaverequestapprovedds_9_tfleaverequestenddate_to, lV70Leaverequestapprovedds_10_tfleaverequesthalfday, AV72Leaverequestapprovedds_12_tfleaverequesthalfday_sel, AV73Leaverequestapprovedds_13_tfleaverequestduration, AV74Leaverequestapprovedds_14_tfleaverequestduration_to, AV75Udparg15});
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            {
               AV26ColumnsSelector_Column = ((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV24ColumnsSelector.gxTpr_Columns.Item(AV76GXV2));
               if ( AV26ColumnsSelector_Column.gxTpr_Isvisible )
               {
                  ...
                  {
                     GXt_decimal4 = AV56EmployeeBalance;
                     new prc_getemployeebalance(context ).execute(  A106EmployeeId, out  GXt_decimal4) ;
                     AV56EmployeeBalance = GXt_decimal4;
                     AV11ExcelDocument.get_Cells(AV14CellRow, (int)(AV15FirstColumn+AV32VisibleColumnCount), 1, 1).Number = (double)(AV56EmployeeBalance);
                  }
                  AV32VisibleColumnCount = (long)(AV32VisibleColumnCount+1);
               }
      ...
      protected void S201( )
      {
         ...
         {
            AV23GridStateFilterValue = ((WorkWithPlus.workwithplus_web.SdtWWPGridState_FilterValue)AV22GridState.gxTpr_Filtervalues.Item(AV77GXV3));
      ...
      public override void initialize( )
      {
         ...
         AV64Leaverequestapprovedds_4_tfleavetypename = "";
         AV65Leaverequestapprovedds_5_tfleavetypename_sel = "";
         AV66Leaverequestapprovedds_6_tfleaverequeststartdate = DateTime.MinValue;
         AV67Leaverequestapprovedds_7_tfleaverequeststartdate_to = DateTime.MinValue;
         AV68Leaverequestapprovedds_8_tfleaverequestenddate = DateTime.MinValue;
         AV69Leaverequestapprovedds_9_tfleaverequestenddate_to = DateTime.MinValue;
         AV70Leaverequestapprovedds_10_tfleaverequesthalfday = "";
         AV72Leaverequestapprovedds_12_tfleaverequesthalfday_sel = "";
         lV61Leaverequestapprovedds_1_filterfulltext = "";
         lV62Leaverequestapprovedds_2_tfemployeename = "";
         lV64Leaverequestapprovedds_4_tfleavetypename = "";
         lV70Leaverequestapprovedds_10_tfleaverequesthalfday = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.leaverequestapprovedexport__default(),
            new Object[][] {
                new Object[] {
               P006X2_A124LeaveTypeId, P006X2_A106EmployeeId, P006X2_A100CompanyId, P006X2_A132LeaveRequestStatus, P006X2_A131LeaveRequestDuration, P006X2_A171LeaveRequestHalfDay, P006X2_n171LeaveRequestHalfDay, P006X2_A130LeaveRequestEndDate, P006X2_A129LeaveRequestStartDate, P006X2_A125LeaveTypeName,
      ...
      private short AV71Leaverequestapprovedds_11_tfleaverequesthalfdayoperator ;
      ...
      private decimal AV73Leaverequestapprovedds_13_tfleaverequestduration ;
      private decimal AV74Leaverequestapprovedds_14_tfleaverequestduration_to ;
      private decimal A131LeaveRequestDuration ;
      private decimal AV56EmployeeBalance ;
      ...
      private string AV62Leaverequestapprovedds_2_tfemployeename ;
      private string AV63Leaverequestapprovedds_3_tfemployeename_sel ;
      private string AV64Leaverequestapprovedds_4_tfleavetypename ;
      private string AV65Leaverequestapprovedds_5_tfleavetypename_sel ;
      private string AV70Leaverequestapprovedds_10_tfleaverequesthalfday ;
      private string AV72Leaverequestapprovedds_12_tfleaverequesthalfday_sel ;
      private string lV62Leaverequestapprovedds_2_tfemployeename ;
      private string lV64Leaverequestapprovedds_4_tfleavetypename ;
      private string lV70Leaverequestapprovedds_10_tfleaverequesthalfday ;
      ...
      private DateTime AV66Leaverequestapprovedds_6_tfleaverequeststartdate ;
      private DateTime AV67Leaverequestapprovedds_7_tfleaverequeststartdate_to ;
      private DateTime AV68Leaverequestapprovedds_8_tfleaverequestenddate ;
      private DateTime AV69Leaverequestapprovedds_9_tfleaverequestenddate_to ;
      ...
      private string AV61Leaverequestapprovedds_1_filterfulltext ;
      private string lV61Leaverequestapprovedds_1_filterfulltext ;
   ...
   public class leaverequestapprovedexport__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P006X2( IGxContext context ,
                                             ...
                                             string AV61Leaverequestapprovedds_1_filterfulltext ,
                                             string AV63Leaverequestapprovedds_3_tfemployeename_sel ,
                                             string AV62Leaverequestapprovedds_2_tfemployeename ,
                                             string AV65Leaverequestapprovedds_5_tfleavetypename_sel ,
                                             string AV64Leaverequestapprovedds_4_tfleavetypename ,
                                             DateTime AV66Leaverequestapprovedds_6_tfleaverequeststartdate ,
                                             DateTime AV67Leaverequestapprovedds_7_tfleaverequeststartdate_to ,
                                             DateTime AV68Leaverequestapprovedds_8_tfleaverequestenddate ,
                                             DateTime AV69Leaverequestapprovedds_9_tfleaverequestenddate_to ,
                                             string AV72Leaverequestapprovedds_12_tfleaverequesthalfday_sel ,
                                             string AV70Leaverequestapprovedds_10_tfleaverequesthalfday ,
                                             short AV71Leaverequestapprovedds_11_tfleaverequesthalfdayoperator ,
                                             decimal AV73Leaverequestapprovedds_13_tfleaverequestduration ,
                                             decimal AV74Leaverequestapprovedds_14_tfleaverequestduration_to ,
                                             ...
                                             string A132LeaveRequestStatus )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV61Leaverequestapprovedds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( LOWER(T3.EmployeeName) like '%' || LOWER(:lV61Leaverequestapprovedds_1_filterfulltext)) or ( LOWER(T2.LeaveTypeName) like '%' || LOWER(:lV61Leaverequestapprovedds_1_filterfulltext)) or ( LOWER(T1.LeaveRequestHalfDay) like '%' || LOWER(:lV61Leaverequestapprovedds_1_filterfulltext)) or ( SUBSTR(TO_CHAR(T1.LeaveRequestDuration,'90.9'), 2) like '%' || :lV61Leaverequestapprovedds_1_filterfulltext))");
         }
         else
         {
            GXv_int5[0] = 1;
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV63Leaverequestapprovedds_3_tfemployeename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV62Leaverequestapprovedds_2_tfemployeename)) ) )
         {
            AddWhere(sWhereString, "(T3.EmployeeName like :lV62Leaverequestapprovedds_2_tfemployeename)");
         }
         else
         {
            GXv_int5[4] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV63Leaverequestapprovedds_3_tfemployeename_sel)) && ! ( StringUtil.StrCmp(AV63Leaverequestapprovedds_3_tfemployeename_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T3.EmployeeName = ( :AV63Leaverequestapprovedds_3_tfemployeename_sel))");
         }
         else
         {
            GXv_int5[5] = 1;
         }
         if ( StringUtil.StrCmp(AV63Leaverequestapprovedds_3_tfemployeename_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from T3.EmployeeName))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV65Leaverequestapprovedds_5_tfleavetypename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV64Leaverequestapprovedds_4_tfleavetypename)) ) )
         {
            AddWhere(sWhereString, "(T2.LeaveTypeName like :lV64Leaverequestapprovedds_4_tfleavetypename)");
         }
         else
         {
            GXv_int5[6] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV65Leaverequestapprovedds_5_tfleavetypename_sel)) && ! ( StringUtil.StrCmp(AV65Leaverequestapprovedds_5_tfleavetypename_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T2.LeaveTypeName = ( :AV65Leaverequestapprovedds_5_tfleavetypename_sel))");
         }
         else
         {
            GXv_int5[7] = 1;
         }
         if ( StringUtil.StrCmp(AV65Leaverequestapprovedds_5_tfleavetypename_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from T2.LeaveTypeName))=0))");
         }
         if ( ! (DateTime.MinValue==AV66Leaverequestapprovedds_6_tfleaverequeststartdate) )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestStartDate >= :AV66Leaverequestapprovedds_6_tfleaverequeststartdate)");
         }
         else
         {
            GXv_int5[8] = 1;
         }
         if ( ! (DateTime.MinValue==AV67Leaverequestapprovedds_7_tfleaverequeststartdate_to) )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestStartDate <= :AV67Leaverequestapprovedds_7_tfleaverequeststartdate_to)");
         }
         else
         {
            GXv_int5[9] = 1;
         }
         if ( ! (DateTime.MinValue==AV68Leaverequestapprovedds_8_tfleaverequestenddate) )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestEndDate >= :AV68Leaverequestapprovedds_8_tfleaverequestenddate)");
         }
         else
         {
            GXv_int5[10] = 1;
         }
         if ( ! (DateTime.MinValue==AV69Leaverequestapprovedds_9_tfleaverequestenddate_to) )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestEndDate <= :AV69Leaverequestapprovedds_9_tfleaverequestenddate_to)");
         }
         else
         {
            GXv_int5[11] = 1;
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV72Leaverequestapprovedds_12_tfleaverequesthalfday_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV70Leaverequestapprovedds_10_tfleaverequesthalfday)) ) )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestHalfDay like :lV70Leaverequestapprovedds_10_tfleaverequesthalfday)");
         }
         else
         {
            GXv_int5[12] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV72Leaverequestapprovedds_12_tfleaverequesthalfday_sel)) && ! ( StringUtil.StrCmp(AV72Leaverequestapprovedds_12_tfleaverequesthalfday_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestHalfDay = ( :AV72Leaverequestapprovedds_12_tfleaverequesthalfday_sel))");
         }
         else
         {
            GXv_int5[13] = 1;
         }
         if ( StringUtil.StrCmp(AV72Leaverequestapprovedds_12_tfleaverequesthalfday_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestHalfDay IS NULL or (char_length(trim(trailing ' ' from T1.LeaveRequestHalfDay))=0))");
         }
         if ( AV71Leaverequestapprovedds_11_tfleaverequesthalfdayoperator == 1 )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestHalfDay = ( 'Morning'))");
         }
         if ( AV71Leaverequestapprovedds_11_tfleaverequesthalfdayoperator == 2 )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestHalfDay = ( 'Afternoon'))");
         }
         if ( ! (Convert.ToDecimal(0)==AV73Leaverequestapprovedds_13_tfleaverequestduration) )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestDuration >= :AV73Leaverequestapprovedds_13_tfleaverequestduration)");
         }
         else
         {
            GXv_int5[14] = 1;
         }
         if ( ! (Convert.ToDecimal(0)==AV74Leaverequestapprovedds_14_tfleaverequestduration_to) )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestDuration <= :AV74Leaverequestapprovedds_14_tfleaverequestduration_to)");
         }
         else
         {
            GXv_int5[15] = 1;
         ...
         {
            AddWhere(sWhereString, "(T2.CompanyId = :AV75Udparg15)");
         }
         else
         {
            GXv_int5[16] = 1;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV61Leaverequestapprovedds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV61Leaverequestapprovedds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV61Leaverequestapprovedds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV61Leaverequestapprovedds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV62Leaverequestapprovedds_2_tfemployeename",GXType.Char,100,0) ,
          new ParDef("AV63Leaverequestapprovedds_3_tfemployeename_sel",GXType.Char,100,0) ,
          new ParDef("lV64Leaverequestapprovedds_4_tfleavetypename",GXType.Char,100,0) ,
          new ParDef("AV65Leaverequestapprovedds_5_tfleavetypename_sel",GXType.Char,100,0) ,
          new ParDef("AV66Leaverequestapprovedds_6_tfleaverequeststartdate",GXType.Date,8,0) ,
          new ParDef("AV67Leaverequestapprovedds_7_tfleaverequeststartdate_to",GXType.Date,8,0) ,
          new ParDef("AV68Leaverequestapprovedds_8_tfleaverequestenddate",GXType.Date,8,0) ,
          new ParDef("AV69Leaverequestapprovedds_9_tfleaverequestenddate_to",GXType.Date,8,0) ,
          new ParDef("lV70Leaverequestapprovedds_10_tfleaverequesthalfday",GXType.Char,20,0) ,
          new ParDef("AV72Leaverequestapprovedds_12_tfleaverequesthalfday_sel",GXType.Char,20,0) ,
          new ParDef("AV73Leaverequestapprovedds_13_tfleaverequestduration",GXType.Number,4,1) ,
          new ParDef("AV74Leaverequestapprovedds_14_tfleaverequestduration_to",GXType.Number,4,1) ,
          new ParDef("AV75Udparg15",GXType.Int64,10,0)
          };
          def= new CursorDef[] {
