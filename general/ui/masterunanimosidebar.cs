...
namespace GeneXus.Programs.general.ui {
   public class masterunanimosidebar : GXMasterPage
   {
      ...
      protected void RenderHtmlCloseForm012( )
      {
         ...
         context.AddJavascriptSource("general/ui/masterunanimosidebar.js", "?2025626750876", false, true);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?2025626750887", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("general/ui/masterunanimosidebar.js", "?2025626750887", false, true);
         context.AddJavascriptSource("Unanimo_chameleon/chameleon.js", "", false, true);
         context.AddJavascriptSource("UserControls/GeneXusUnanimo.SidebarRender.js", "", false, true);
