...
namespace GeneXus.Programs {
   public class gamchangepassword : GXHttpHandler
   {
      ...
      protected void E11062( )
      {
         ...
         if ( StringUtil.StrCmp(AV42HTTPRequest.Method, "GET") == 0 )
         {
         ...
         AV45User = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getusertochangepassword();
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV45User.gxTpr_Name)) )
         {
            AV10UserName = AV45User.gxTpr_Name;
            AssignAttri("", false, "AV10UserName", AV10UserName);
         }
         else
         {
            AV44Errors = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getlasterrors();
      ...
      protected void E12062( )
      {
         ...
         {
            AV7isOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).updateusertochangepassword(AV11UserPassword, AV12UserPasswordNew, out  AV44Errors);
            if ( AV7isOK )
            {
               if ( AV44Errors.Count > 0 )
               {
      ...
      protected void E13062( )
      {
         ...
         returnInSub = false;
         AV7isOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).logout(out  AV44Errors);
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV50GXV1 = 1;
         while ( AV50GXV1 <= AV44Errors.Count )
         {
            AV43Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV44Errors.Item(AV50GXV1));
            GX_msglist.addItem(StringUtil.Format( "%1 (GAM%2)", AV43Error.gxTpr_Message, StringUtil.LTrimStr( (decimal)(AV43Error.gxTpr_Code), 12, 0), "", "", "", "", "", "", ""));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202572513525084", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamchangepassword.js", "?202572513525092", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV42HTTPRequest = new GxHttpRequest( context);
         AV45User = new GeneXus.Programs.genexussecurity.SdtGAMUser(context);
         AV44Errors = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError>( context, "GeneXus.Programs.genexussecurity.SdtGAMError", "GeneXus.Programs");
         AV8URL = "";
         AV43Error = new GeneXus.Programs.genexussecurity.SdtGAMError(context);
         sStyleString = "";
      ...
      private GxHttpRequest AV42HTTPRequest ;
      private IGxDataStore dsGAM ;
      private IGxDataStore dsDefault ;
      private string aP0_IDP_State ;
      private GeneXus.Programs.genexussecurity.SdtGAMUser AV45User ;
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError> AV44Errors ;
      private GeneXus.Programs.genexussecurity.SdtGAMError AV43Error ;
