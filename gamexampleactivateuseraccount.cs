...
namespace GeneXus.Programs {
   public class gamexampleactivateuseraccount : GXHttpHandler
   {
      ...
      protected void E110E2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV8isOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).activateuser(AV5ActivationKey, true, out  AV25GAMErrorCollection);
         if ( AV8isOK )
         {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV27GXV1 = 1;
         while ( AV27GXV1 <= AV25GAMErrorCollection.Count )
         {
            AV24GAMError = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV25GAMErrorCollection.Item(AV27GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256241962148", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexampleactivateuseraccount.js", "?20256241962150", false, true);
