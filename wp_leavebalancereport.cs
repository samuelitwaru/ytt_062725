...
namespace GeneXus.Programs {
   public class wp_leavebalancereport : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV14SDT_EmployeeBalanceActions, AV38Year) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "EMPLOYEEISACTIVE", A112EmployeeIsActive);
         ...
         GxWebStd.gx_hidden_field( context, "LEAVEREQUESTHALFDAY", StringUtil.RTrim( A171LeaveRequestHalfDay));
         ...
         GxWebStd.gx_hidden_field( context, "DVELOP_CONFIRMPANEL_USERACTION1_Title", StringUtil.RTrim( Dvelop_confirmpanel_useraction1_Title));
         GxWebStd.gx_hidden_field( context, "DVELOP_CONFIRMPANEL_USERACTION1_Confirmationtext", StringUtil.RTrim( Dvelop_confirmpanel_useraction1_Confirmationtext));
         GxWebStd.gx_hidden_field( context, "DVELOP_CONFIRMPANEL_USERACTION1_Yesbuttoncaption", StringUtil.RTrim( Dvelop_confirmpanel_useraction1_Yesbuttoncaption));
         GxWebStd.gx_hidden_field( context, "DVELOP_CONFIRMPANEL_USERACTION1_Nobuttoncaption", StringUtil.RTrim( Dvelop_confirmpanel_useraction1_Nobuttoncaption));
         GxWebStd.gx_hidden_field( context, "DVELOP_CONFIRMPANEL_USERACTION1_Cancelbuttoncaption", StringUtil.RTrim( Dvelop_confirmpanel_useraction1_Cancelbuttoncaption));
         GxWebStd.gx_hidden_field( context, "DVELOP_CONFIRMPANEL_USERACTION1_Yesbuttonposition", StringUtil.RTrim( Dvelop_confirmpanel_useraction1_Yesbuttonposition));
         GxWebStd.gx_hidden_field( context, "DVELOP_CONFIRMPANEL_USERACTION1_Confirmtype", StringUtil.RTrim( Dvelop_confirmpanel_useraction1_Confirmtype));
         ...
         GxWebStd.gx_hidden_field( context, "GRIDPAGINATIONBAR_Rowsperpageselectedvalue", StringUtil.LTrim( StringUtil.NToC( (decimal)(Gridpaginationbar_Rowsperpageselectedvalue), 9, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "DVELOP_CONFIRMPANEL_USERACTION1_Result", StringUtil.RTrim( Dvelop_confirmpanel_useraction1_Result));
      ...
      protected void WB5E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "DscTop", "start", "top", "", "flex-grow:1;", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtablebalance_Internalname, 1, 0, "px", 0, "px", "Table", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 MergeLabelCell", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbalance_Internalname, "Employee Balance", "", "", lblTextblockbalance_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WP_LeaveBalanceReport.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavBalance_Internalname, "Balance", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 35,'',false,'" + sGXsfl_43_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBalance_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV54Balance), 4, 0, ".", "")), StringUtil.LTrim( ((edtavBalance_Enabled!=0) ? context.localUtil.Format( (decimal)(AV54Balance), "ZZZ9") : context.localUtil.Format( (decimal)(AV54Balance), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,35);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBalance_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavBalance_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WP_LeaveBalanceReport.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 43 )
         {
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 58,'',false,'" + sGXsfl_43_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavEmployeeid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV50EmployeeId), 4, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV50EmployeeId), "ZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,58);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavEmployeeid_Jsonclick, 0, "Attribute", "", "", "", "", edtavEmployeeid_Visible, 1, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WP_LeaveBalanceReport.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 59,'',false,'" + sGXsfl_43_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavEmployeebalance_Internalname, StringUtil.LTrim( StringUtil.NToC( AV37EmployeeBalance, 4, 1, ".", "")), StringUtil.LTrim( context.localUtil.Format( AV37EmployeeBalance, "Z9.9")), TempTags+" onchange=\""+"gx.num.valid_decimal( this, ',','.','1');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, ',','.','1');"+";gx.evt.onblur(this,59);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavEmployeebalance_Jsonclick, 0, "Attribute", "", "", "", "", edtavEmployeebalance_Visible, 1, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WP_LeaveBalanceReport.htm");
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VUSERACTION2.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VUSERACTION2.CLICK") == 0 ) )
                           {
                              ...
                              AV55GXV1 = (int)(nGXsfl_43_idx+GRID_nFirstRecordOnPage);
                              if ( ( AV14SDT_EmployeeBalanceActions.Count >= AV55GXV1 ) && ( AV55GXV1 > 0 ) )
                              {
                                 AV14SDT_EmployeeBalanceActions.CurrentItem = ((SdtSDT_EmployeeBalanceAction)AV14SDT_EmployeeBalanceActions.Item(AV55GXV1));
                                 AV52UserAction1 = cgiGet( edtavUseraction1_Internalname);
                                 AssignAttri("", false, edtavUseraction1_Internalname, AV52UserAction1);
                                 AV53UserAction2 = cgiGet( edtavUseraction2_Internalname);
                                 AssignAttri("", false, edtavUseraction2_Internalname, AV53UserAction2);
                              }
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
      ...
      protected void initialize_formulas( )
      {
         ...
         edtavBalance_Enabled = 0;
         AssignProp("", false, edtavBalance_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavBalance_Enabled), 5, 0), true);
      ...
      protected void STRUP5E0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            Dvelop_confirmpanel_useraction1_Title = cgiGet( "DVELOP_CONFIRMPANEL_USERACTION1_Title");
            Dvelop_confirmpanel_useraction1_Confirmationtext = cgiGet( "DVELOP_CONFIRMPANEL_USERACTION1_Confirmationtext");
            Dvelop_confirmpanel_useraction1_Yesbuttoncaption = cgiGet( "DVELOP_CONFIRMPANEL_USERACTION1_Yesbuttoncaption");
            Dvelop_confirmpanel_useraction1_Nobuttoncaption = cgiGet( "DVELOP_CONFIRMPANEL_USERACTION1_Nobuttoncaption");
            Dvelop_confirmpanel_useraction1_Cancelbuttoncaption = cgiGet( "DVELOP_CONFIRMPANEL_USERACTION1_Cancelbuttoncaption");
            Dvelop_confirmpanel_useraction1_Yesbuttonposition = cgiGet( "DVELOP_CONFIRMPANEL_USERACTION1_Yesbuttonposition");
            Dvelop_confirmpanel_useraction1_Confirmtype = cgiGet( "DVELOP_CONFIRMPANEL_USERACTION1_Confirmtype");
            ...
            Gridpaginationbar_Rowsperpageselectedvalue = (int)(Math.Round(context.localUtil.CToN( cgiGet( "GRIDPAGINATIONBAR_Rowsperpageselectedvalue"), ".", ","), 18, MidpointRounding.ToEven));
            Dvelop_confirmpanel_useraction1_Result = cgiGet( "DVELOP_CONFIRMPANEL_USERACTION1_Result");
            ...
            while ( nGXsfl_43_fel_idx < nRC_GXsfl_43 )
            {
               ...
               AV55GXV1 = (int)(nGXsfl_43_fel_idx+GRID_nFirstRecordOnPage);
               if ( ( AV14SDT_EmployeeBalanceActions.Count >= AV55GXV1 ) && ( AV55GXV1 > 0 ) )
               {
                  AV14SDT_EmployeeBalanceActions.CurrentItem = ((SdtSDT_EmployeeBalanceAction)AV14SDT_EmployeeBalanceActions.Item(AV55GXV1));
                  AV52UserAction1 = cgiGet( edtavUseraction1_Internalname);
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavBalance_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavBalance_Internalname), ".", ",") > Convert.ToDecimal( 9999 )) ) )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_badnum", ""), 1, "vBALANCE");
               GX_FocusControl = edtavBalance_Internalname;
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV54Balance = 0;
               AssignAttri("", false, "AV54Balance", StringUtil.LTrimStr( (decimal)(AV54Balance), 4, 0));
            }
            else
            {
               AV54Balance = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtavBalance_Internalname), ".", ","), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV54Balance", StringUtil.LTrimStr( (decimal)(AV54Balance), 4, 0));
            }
            if ( ( ( context.localUtil.CToN( cgiGet( edtavEmployeeid_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavEmployeeid_Internalname), ".", ",") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV50EmployeeId = 0;
               AssignAttri("", false, "AV50EmployeeId", StringUtil.LTrimStr( (decimal)(AV50EmployeeId), 4, 0));
            }
            else
            {
               AV50EmployeeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtavEmployeeid_Internalname), ".", ","), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV50EmployeeId", StringUtil.LTrimStr( (decimal)(AV50EmployeeId), 4, 0));
            }
      ...
      protected void E175E2( )
      {
         ...
         {
            AV63Udparg1 = new getloggedinemployeeid(context).executeUdp( );
            /* Using cursor H005E2 */
            pr_default.execute(0, new Object[] {AV63Udparg1});
         ...
         {
            AV65Udparg2 = new getloggedinusercompanyid(context).executeUdp( );
            /* Using cursor H005E3 */
            pr_default.execute(1, new Object[] {AV65Udparg2});
            while ( (pr_default.getStatus(1) != 101) )
            {
               A112EmployeeIsActive = H005E3_A112EmployeeIsActive[0];
         ...
         {
            AV50EmployeeId = (short)(AV43EmployeeIdsToShow.GetNumeric(1));
            AssignAttri("", false, "AV50EmployeeId", StringUtil.LTrimStr( (decimal)(AV50EmployeeId), 4, 0));
         }
         ...
         S112 ();
         if (returnInSub) return;
         edtavEmployeebalance_Visible = 0;
         AssignProp("", false, edtavEmployeebalance_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavEmployeebalance_Visible), 5, 0), true);
      ...
      private void E195E2( )
      {
         ...
         returnInSub = false;
         AV55GXV1 = 1;
         while ( AV55GXV1 <= AV14SDT_EmployeeBalanceActions.Count )
         {
            AV14SDT_EmployeeBalanceActions.CurrentItem = ((SdtSDT_EmployeeBalanceAction)AV14SDT_EmployeeBalanceActions.Item(AV55GXV1));
            AV52UserAction1 = "<i class=\"fas fa-xmark\"></i>";
            AssignAttri("", false, edtavUseraction1_Internalname, AV52UserAction1);
            ...
            AV53UserAction2 = "<i class=\"fas fa-pen\"></i>";
            AssignAttri("", false, edtavUseraction2_Internalname, AV53UserAction2);
            if ( StringUtil.StrCmp(((SdtSDT_EmployeeBalanceAction)(AV14SDT_EmployeeBalanceActions.CurrentItem)).gxTpr_Type, "SET") == 0 )
            {
            ...
            {
               edtavUseraction2_Class = "Invisible";
            }
            /* Load Method */
            if ( wbStart != -1 )
            {
      ...
      protected void E125E2( )
      {
         ...
         {
            AV26PageToGo = subGrid_fnc_Currentpage( );
            AV26PageToGo = (int)(AV26PageToGo+1);
      ...
      {
         AV55GXV1 = (int)(nGXsfl_43_idx+GRID_nFirstRecordOnPage);
         if ( ( AV55GXV1 > 0 ) && ( AV14SDT_EmployeeBalanceActions.Count >= AV55GXV1 ) )
         {
            AV14SDT_EmployeeBalanceActions.CurrentItem = ((SdtSDT_EmployeeBalanceAction)AV14SDT_EmployeeBalanceActions.Item(AV55GXV1));
         }
      ...
      protected void E115E2( )
      {
         ...
         returnInSub = false;
         AV50EmployeeId = (short)(Math.Round(NumberUtil.Val( Combo_employeeid_Selectedvalue_get, "."), 18, MidpointRounding.ToEven));
         AssignAttri("", false, "AV50EmployeeId", StringUtil.LTrimStr( (decimal)(AV50EmployeeId), 4, 0));
         /* Execute user subroutine: 'GETDATA' */
         S122 ();
         if (returnInSub) return;
      ...
      protected void S142( )
      {
         ...
         returnInSub = false;
         /* Using cursor H005E4 */
         pr_default.execute(2, new Object[] {AV50EmployeeId, ((SdtSDT_EmployeeBalanceAction)(AV14SDT_EmployeeBalanceActions.CurrentItem)).gxTpr_Startdate});
         while ( (pr_default.getStatus(2) != 101) )
         {
            A186VacationSetDate = H005E4_A186VacationSetDate[0];
            A106EmployeeId = H005E4_A106EmployeeId[0];
            AV45BC_Employee.Load(AV50EmployeeId);
            ...
            {
               AV69GXV9 = 1;
               AV68GXV8 = AV45BC_Employee.GetMessages();
               while ( AV69GXV9 <= AV68GXV8.Count )
               {
                  AV46Message = ((GeneXus.Utils.SdtMessages_Message)AV68GXV8.Item(AV69GXV9));
      ...
      protected void S112( )
      {
         ...
         pr_default.close(3);
         Combo_employeeid_Selectedvalue_set = ((0==AV50EmployeeId) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV50EmployeeId), 4, 0)));
      ...
      protected void S122( )
      {
         /* 'GETDATA' Routine */
         returnInSub = false;
         GXt_decimal2 = AV37EmployeeBalance;
         new prc_getemployeebalance(context ).execute(  AV50EmployeeId, out  GXt_decimal2) ;
         AV37EmployeeBalance = GXt_decimal2;
         AssignAttri("", false, "AV37EmployeeBalance", StringUtil.LTrimStr( AV37EmployeeBalance, 4, 1));
         AV54Balance = (short)(Math.Round(AV37EmployeeBalance, 18, MidpointRounding.ToEven));
         AssignAttri("", false, "AV54Balance", StringUtil.LTrimStr( (decimal)(AV54Balance), 4, 0));
         AV14SDT_EmployeeBalanceActions.Clear();
         gx_BV43 = true;
         /* Using cursor H005E6 */
         pr_default.execute(4, new Object[] {AV50EmployeeId});
         while ( (pr_default.getStatus(4) != 101) )
         {
            A106EmployeeId = H005E6_A106EmployeeId[0];
            A146EmployeeVactionDays = H005E6_A146EmployeeVactionDays[0];
            A112EmployeeIsActive = H005E6_A112EmployeeIsActive[0];
            ...
            while ( (pr_default.getStatus(6) != 101) )
            {
               ...
               A171LeaveRequestHalfDay = H005E8_A171LeaveRequestHalfDay[0];
               n171LeaveRequestHalfDay = H005E8_n171LeaveRequestHalfDay[0];
               ...
               AV51LeaveRequestDuration = A131LeaveRequestDuration;
               if ( DateTimeUtil.ResetTime ( A129LeaveRequestStartDate ) < DateTimeUtil.ResetTime ( context.localUtil.YMDToD( AV38Year, 1, 1) ) )
               {
                  GXt_decimal2 = AV51LeaveRequestDuration;
                  new prc_getleaverequestdays(context ).execute(  context.localUtil.YMDToD( AV38Year, 1, 1),  A130LeaveRequestEndDate,  A171LeaveRequestHalfDay,  AV50EmployeeId, out  GXt_decimal2) ;
                  AV51LeaveRequestDuration = GXt_decimal2;
               }
               if ( DateTimeUtil.ResetTime ( A130LeaveRequestEndDate ) > DateTimeUtil.ResetTime ( context.localUtil.YMDToD( AV38Year, 12, 31) ) )
               {
                  GXt_decimal2 = AV51LeaveRequestDuration;
                  new prc_getleaverequestdays(context ).execute(  A129LeaveRequestStartDate,  context.localUtil.YMDToD( AV38Year, 12, 31),  A171LeaveRequestHalfDay,  AV50EmployeeId, out  GXt_decimal2) ;
                  AV51LeaveRequestDuration = GXt_decimal2;
               }
               AV34SDT_EmployeeBalanceAction.gxTpr_Durationindays = (decimal)(AV51LeaveRequestDuration*-1);
               AV34SDT_EmployeeBalanceAction.gxTpr_Durationinhours = (decimal)(AV51LeaveRequestDuration*8*-1);
               AV34SDT_EmployeeBalanceAction.gxTpr_Description = A133LeaveRequestDescription;
               AV14SDT_EmployeeBalanceActions.Add(AV34SDT_EmployeeBalanceAction, 0);
               gx_BV43 = true;
               /* Using cursor H005E9 */
               pr_default.execute(7, new Object[] {AV36CompanyId, AV38Year, A129LeaveRequestStartDate, A130LeaveRequestEndDate});
      ...
      protected void wb_table1_60_5E2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"DVELOP_CONFIRMPANEL_USERACTION1Container"+"Body"+"\" style=\"display:none;\">") ;
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20261310101719", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_leavebalancereport.js", "?20261310101720", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         edtavUseraction1_Internalname = "vUSERACTION1_"+sGXsfl_43_idx;
         edtavUseraction2_Internalname = "vUSERACTION2_"+sGXsfl_43_idx;
      ...
      {
         edtavUseraction1_Internalname = "vUSERACTION1_"+sGXsfl_43_fel_idx;
         edtavUseraction2_Internalname = "vUSERACTION2_"+sGXsfl_43_fel_idx;
      ...
      protected void sendrow_432( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_43_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavUseraction1_Internalname,StringUtil.RTrim( AV52UserAction1),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,44);\"",(string)"'"+""+"'"+",false,"+"'"+"e215e2_client"+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavUseraction1_Jsonclick,(short)7,(string)edtavUseraction1_Class,(string)"",(string)ROClassString,(string)"WWIconActionColumn",(string)"",(short)-1,(int)edtavUseraction1_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)1,(short)43,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavUseraction2_Internalname,StringUtil.RTrim( AV53UserAction2),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,45);\"","'"+""+"'"+",false,"+"'"+"EVUSERACTION2.CLICK."+sGXsfl_43_idx+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavUseraction2_Jsonclick,(short)5,(string)edtavUseraction2_Class,(string)"",(string)ROClassString,(string)"WWIconActionColumn",(string)"",(short)-1,(int)edtavUseraction2_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)1,(short)43,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl43( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+edtavUseraction2_Class+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "") ;
            context.WriteHtmlTextNl( "</th>") ;
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( AV52UserAction1)));
            ...
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( AV53UserAction2)));
      ...
      protected void init_default_properties( )
      {
         ...
         lblTextblockbalance_Internalname = "TEXTBLOCKBALANCE";
         edtavBalance_Internalname = "vBALANCE";
         divUnnamedtablebalance_Internalname = "UNNAMEDTABLEBALANCE";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavBalance_Jsonclick = "";
         edtavBalance_Enabled = 1;
         edtavYear_Jsonclick = "";
         edtavYear_Enabled = 1;
         ...
         Dvelop_confirmpanel_useraction1_Confirmationtext = "Are sure you want to delete Vacation Days Set";
         Dvelop_confirmpanel_useraction1_Title = "Confirm Delete";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14SDT_EmployeeBalanceActions","fld":"vSDT_EMPLOYEEBALANCEACTIONS","grid":43},{"av":"nGXsfl_43_idx","ctrl":"GRID","prop":"GridCurrRow","grid":43},{"av":"nRC_GXsfl_43","ctrl":"GRID","prop":"GridRC","grid":43},{"av":"AV38Year","fld":"vYEAR","pic":"ZZZ9","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV27GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV28GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"ctrl":"BTNSETVACATIONDAYSBTN","prop":"Visible"}]}""");
         ...
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV52UserAction1","fld":"vUSERACTION1"},{"av":"edtavUseraction1_Class","ctrl":"vUSERACTION1","prop":"Class"},{"av":"AV53UserAction2","fld":"vUSERACTION2"},{"av":"edtavUseraction2_Class","ctrl":"vUSERACTION2","prop":"Class"}]}""");
         ...
         setEventMetadata("VUSERACTION1.CLICK","""{"handler":"E215E2","iparms":[]}""");
         setEventMetadata("DVELOP_CONFIRMPANEL_USERACTION1.CLOSE","""{"handler":"E145E2","iparms":[{"av":"Dvelop_confirmpanel_useraction1_Result","ctrl":"DVELOP_CONFIRMPANEL_USERACTION1","prop":"Result"},{"av":"A106EmployeeId","fld":"EMPLOYEEID","pic":"ZZZZZZZZZ9"},{"av":"AV50EmployeeId","fld":"vEMPLOYEEID","pic":"ZZZ9"},{"av":"A186VacationSetDate","fld":"VACATIONSETDATE"},{"av":"AV14SDT_EmployeeBalanceActions","fld":"vSDT_EMPLOYEEBALANCEACTIONS","grid":43},{"av":"nGXsfl_43_idx","ctrl":"GRID","prop":"GridCurrRow","grid":43},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_43","ctrl":"GRID","prop":"GridRC","grid":43},{"av":"A112EmployeeIsActive","fld":"EMPLOYEEISACTIVE"},{"av":"A100CompanyId","fld":"COMPANYID","pic":"ZZZZZZZZZ9"},{"av":"AV38Year","fld":"vYEAR","pic":"ZZZ9","hsh":true},{"av":"A189VacationSetDescription","fld":"VACATIONSETDESCRIPTION"},{"av":"A179VacationSetDays","fld":"VACATIONSETDAYS","pic":"Z9.9"},{"av":"A146EmployeeVactionDays","fld":"EMPLOYEEVACTIONDAYS","pic":"Z9.9"},{"av":"A132LeaveRequestStatus","fld":"LEAVEREQUESTSTATUS"},{"av":"A144LeaveTypeVacationLeave","fld":"LEAVETYPEVACATIONLEAVE"},{"av":"A145LeaveTypeLoggingWorkHours","fld":"LEAVETYPELOGGINGWORKHOURS"},{"av":"A129LeaveRequestStartDate","fld":"LEAVEREQUESTSTARTDATE"},{"av":"A130LeaveRequestEndDate","fld":"LEAVEREQUESTENDDATE"},{"av":"A131LeaveRequestDuration","fld":"LEAVEREQUESTDURATION","pic":"Z9.9"},{"av":"A171LeaveRequestHalfDay","fld":"LEAVEREQUESTHALFDAY"},{"av":"A133LeaveRequestDescription","fld":"LEAVEREQUESTDESCRIPTION"},{"av":"A139HolidayIsActive","fld":"HOLIDAYISACTIVE"},{"av":"A115HolidayStartDate","fld":"HOLIDAYSTARTDATE"},{"av":"A116HolidayEndDate","fld":"HOLIDAYENDDATE"},{"av":"A114HolidayName","fld":"HOLIDAYNAME"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]""");
         setEventMetadata("DVELOP_CONFIRMPANEL_USERACTION1.CLOSE",""","oparms":[{"av":"AV37EmployeeBalance","fld":"vEMPLOYEEBALANCE","pic":"Z9.9"},{"av":"AV54Balance","fld":"vBALANCE","pic":"ZZZ9"},{"av":"AV14SDT_EmployeeBalanceActions","fld":"vSDT_EMPLOYEEBALANCEACTIONS","grid":43},{"av":"nGXsfl_43_idx","ctrl":"GRID","prop":"GridCurrRow","grid":43},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_43","ctrl":"GRID","prop":"GridRC","grid":43},{"av":"AV36CompanyId","fld":"vCOMPANYID","pic":"ZZZZZZZZZ9"}]}""");
         ...
         setEventMetadata("SETVACATIONDAYSBTN_MODAL.CLOSE","""{"handler":"E155E2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14SDT_EmployeeBalanceActions","fld":"vSDT_EMPLOYEEBALANCEACTIONS","grid":43},{"av":"nGXsfl_43_idx","ctrl":"GRID","prop":"GridCurrRow","grid":43},{"av":"nRC_GXsfl_43","ctrl":"GRID","prop":"GridRC","grid":43},{"av":"AV38Year","fld":"vYEAR","pic":"ZZZ9","hsh":true},{"av":"AV50EmployeeId","fld":"vEMPLOYEEID","pic":"ZZZ9"},{"av":"A106EmployeeId","fld":"EMPLOYEEID","pic":"ZZZZZZZZZ9"},{"av":"A112EmployeeIsActive","fld":"EMPLOYEEISACTIVE"},{"av":"A100CompanyId","fld":"COMPANYID","pic":"ZZZZZZZZZ9"},{"av":"A186VacationSetDate","fld":"VACATIONSETDATE"},{"av":"A189VacationSetDescription","fld":"VACATIONSETDESCRIPTION"},{"av":"A179VacationSetDays","fld":"VACATIONSETDAYS","pic":"Z9.9"},{"av":"A146EmployeeVactionDays","fld":"EMPLOYEEVACTIONDAYS","pic":"Z9.9"},{"av":"A132LeaveRequestStatus","fld":"LEAVEREQUESTSTATUS"},{"av":"A144LeaveTypeVacationLeave","fld":"LEAVETYPEVACATIONLEAVE"},{"av":"A145LeaveTypeLoggingWorkHours","fld":"LEAVETYPELOGGINGWORKHOURS"},{"av":"A129LeaveRequestStartDate","fld":"LEAVEREQUESTSTARTDATE"},{"av":"A130LeaveRequestEndDate","fld":"LEAVEREQUESTENDDATE"},{"av":"A131LeaveRequestDuration","fld":"LEAVEREQUESTDURATION","pic":"Z9.9"},{"av":"A171LeaveRequestHalfDay","fld":"LEAVEREQUESTHALFDAY"},{"av":"A133LeaveRequestDescription","fld":"LEAVEREQUESTDESCRIPTION"},{"av":"A139HolidayIsActive","fld":"HOLIDAYISACTIVE"},{"av":"A115HolidayStartDate","fld":"HOLIDAYSTARTDATE"},{"av":"A116HolidayEndDate","fld":"HOLIDAYENDDATE"},{"av":"A114HolidayName","fld":"HOLIDAYNAME"}]""");
         setEventMetadata("SETVACATIONDAYSBTN_MODAL.CLOSE",""","oparms":[{"av":"AV37EmployeeBalance","fld":"vEMPLOYEEBALANCE","pic":"Z9.9"},{"av":"AV54Balance","fld":"vBALANCE","pic":"ZZZ9"},{"av":"AV14SDT_EmployeeBalanceActions","fld":"vSDT_EMPLOYEEBALANCEACTIONS","grid":43},{"av":"nGXsfl_43_idx","ctrl":"GRID","prop":"GridCurrRow","grid":43},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_43","ctrl":"GRID","prop":"GridRC","grid":43},{"av":"AV36CompanyId","fld":"vCOMPANYID","pic":"ZZZZZZZZZ9"},{"av":"AV27GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV28GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"ctrl":"BTNSETVACATIONDAYSBTN","prop":"Visible"}]}""");
         setEventMetadata("COMBO_EMPLOYEEID.ONOPTIONCLICKED","""{"handler":"E115E2","iparms":[{"av":"Combo_employeeid_Selectedvalue_get","ctrl":"COMBO_EMPLOYEEID","prop":"SelectedValue_get"},{"av":"AV50EmployeeId","fld":"vEMPLOYEEID","pic":"ZZZ9"},{"av":"A106EmployeeId","fld":"EMPLOYEEID","pic":"ZZZZZZZZZ9"},{"av":"A112EmployeeIsActive","fld":"EMPLOYEEISACTIVE"},{"av":"A100CompanyId","fld":"COMPANYID","pic":"ZZZZZZZZZ9"},{"av":"A186VacationSetDate","fld":"VACATIONSETDATE"},{"av":"AV38Year","fld":"vYEAR","pic":"ZZZ9","hsh":true},{"av":"A189VacationSetDescription","fld":"VACATIONSETDESCRIPTION"},{"av":"A179VacationSetDays","fld":"VACATIONSETDAYS","pic":"Z9.9"},{"av":"A146EmployeeVactionDays","fld":"EMPLOYEEVACTIONDAYS","pic":"Z9.9"},{"av":"A132LeaveRequestStatus","fld":"LEAVEREQUESTSTATUS"},{"av":"A144LeaveTypeVacationLeave","fld":"LEAVETYPEVACATIONLEAVE"},{"av":"A145LeaveTypeLoggingWorkHours","fld":"LEAVETYPELOGGINGWORKHOURS"},{"av":"A129LeaveRequestStartDate","fld":"LEAVEREQUESTSTARTDATE"},{"av":"A130LeaveRequestEndDate","fld":"LEAVEREQUESTENDDATE"},{"av":"A131LeaveRequestDuration","fld":"LEAVEREQUESTDURATION","pic":"Z9.9"},{"av":"A171LeaveRequestHalfDay","fld":"LEAVEREQUESTHALFDAY"},{"av":"A133LeaveRequestDescription","fld":"LEAVEREQUESTDESCRIPTION"},{"av":"A139HolidayIsActive","fld":"HOLIDAYISACTIVE"},{"av":"A115HolidayStartDate","fld":"HOLIDAYSTARTDATE"},{"av":"A116HolidayEndDate","fld":"HOLIDAYENDDATE"},{"av":"A114HolidayName","fld":"HOLIDAYNAME"},{"av":"AV14SDT_EmployeeBalanceActions","fld":"vSDT_EMPLOYEEBALANCEACTIONS","grid":43},{"av":"nGXsfl_43_idx","ctrl":"GRID","prop":"GridCurrRow","grid":43},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_43","ctrl":"GRID","prop":"GridRC","grid":43},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]""");
         setEventMetadata("COMBO_EMPLOYEEID.ONOPTIONCLICKED",""","oparms":[{"av":"AV50EmployeeId","fld":"vEMPLOYEEID","pic":"ZZZ9"},{"av":"AV37EmployeeBalance","fld":"vEMPLOYEEBALANCE","pic":"Z9.9"},{"av":"AV54Balance","fld":"vBALANCE","pic":"ZZZ9"},{"av":"AV14SDT_EmployeeBalanceActions","fld":"vSDT_EMPLOYEEBALANCEACTIONS","grid":43},{"av":"nGXsfl_43_idx","ctrl":"GRID","prop":"GridCurrRow","grid":43},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_43","ctrl":"GRID","prop":"GridRC","grid":43},{"av":"AV36CompanyId","fld":"vCOMPANYID","pic":"ZZZZZZZZZ9"}]}""");
         setEventMetadata("VUSERACTION2.CLICK","""{"handler":"E205E2","iparms":[{"av":"AV14SDT_EmployeeBalanceActions","fld":"vSDT_EMPLOYEEBALANCEACTIONS","grid":43},{"av":"nGXsfl_43_idx","ctrl":"GRID","prop":"GridCurrRow","grid":43},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_43","ctrl":"GRID","prop":"GridRC","grid":43}]""");
         setEventMetadata("VUSERACTION2.CLICK",""","oparms":[{"av":"Gx_mode","fld":"vMODE","pic":"@!"},{"av":"AV48EmployeeVacationDaysSetDate","fld":"vEMPLOYEEVACATIONDAYSSETDATE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         H005E3_A112EmployeeIsActive = new bool[] {false} ;
         ...
         AV68GXV8 = new GXBaseCollection<GeneXus.Utils.SdtMessages_Message>( context, "Message", "GeneXus");
         ...
         H005E6_A112EmployeeIsActive = new bool[] {false} ;
         ...
         H005E8_A171LeaveRequestHalfDay = new string[] {""} ;
         H005E8_n171LeaveRequestHalfDay = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wp_leavebalancereport__default(),
            new Object[][] {
               ...
               , new Object[] {
               H005E3_A112EmployeeIsActive, H005E3_A100CompanyId, H005E3_A106EmployeeId
               }
               , new Object[] {
               ...
               , new Object[] {
               H005E6_A106EmployeeId, H005E6_A146EmployeeVactionDays, H005E6_A112EmployeeIsActive, H005E6_A100CompanyId
               }
               , new Object[] {
               ...
               , new Object[] {
               H005E8_A127LeaveRequestId, H005E8_A124LeaveTypeId, H005E8_A106EmployeeId, H005E8_A130LeaveRequestEndDate, H005E8_A129LeaveRequestStartDate, H005E8_A145LeaveTypeLoggingWorkHours, H005E8_A144LeaveTypeVacationLeave, H005E8_A132LeaveRequestStatus, H005E8_A131LeaveRequestDuration, H005E8_A171LeaveRequestHalfDay,
               H005E8_n171LeaveRequestHalfDay, H005E8_A133LeaveRequestDescription
               }
               , new Object[] {
      ...
      private short AV54Balance ;
      private short AV50EmployeeId ;
      ...
      private int edtavBalance_Enabled ;
      ...
      private decimal AV51LeaveRequestDuration ;
      ...
      private string divUnnamedtablebalance_Internalname ;
      private string lblTextblockbalance_Internalname ;
      private string lblTextblockbalance_Jsonclick ;
      private string edtavBalance_Internalname ;
      private string edtavBalance_Jsonclick ;
      ...
      private string AV52UserAction1 ;
      private string edtavUseraction1_Internalname ;
      private string AV53UserAction2 ;
      ...
      private bool[] H005E3_A112EmployeeIsActive ;
      ...
      private GXBaseCollection<GeneXus.Utils.SdtMessages_Message> AV68GXV8 ;
      ...
      private bool[] H005E6_A112EmployeeIsActive ;
      ...
      private string[] H005E8_A171LeaveRequestHalfDay ;
      private bool[] H005E8_n171LeaveRequestHalfDay ;
 ...
 public class wp_leavebalancereport__default : DataStoreHelperBase, IDataStoreHelper
 {
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        new ParDef("AV65Udparg2",GXType.Int64,10,0)
        };
        Object[] prmH005E4;
        prmH005E4 = new Object[] {
        new ParDef("AV50EmployeeId",GXType.Int16,4,0) ,
        ...
        def= new CursorDef[] {
            new CursorDef("H005E2", "SELECT ProjectManagerId, ProjectId FROM Project WHERE ProjectManagerId = :AV63Udparg1 ORDER BY ProjectManagerId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005E2,100, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("H005E3", "SELECT EmployeeIsActive, CompanyId, EmployeeId FROM Employee WHERE (CompanyId = :AV65Udparg2) AND (EmployeeIsActive = TRUE) ORDER BY CompanyId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005E3,100, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("H005E4", "SELECT VacationSetDate, EmployeeId FROM EmployeeVacationSet WHERE EmployeeId = :AV50EmployeeId and VacationSetDate = :SdtSDTCurrentItem_1Startd ORDER BY EmployeeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005E4,1, GxCacheFrequency.OFF ,true,true )
           ...
           ,new CursorDef("H005E6", "SELECT EmployeeId, EmployeeVactionDays, EmployeeIsActive, CompanyId FROM Employee WHERE (EmployeeId = :AV50EmployeeId) AND (EmployeeIsActive = TRUE) ORDER BY EmployeeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005E6,1, GxCacheFrequency.OFF ,true,true )
           ...
           ,new CursorDef("H005E8", "SELECT T1.LeaveRequestId, T1.LeaveTypeId, T1.EmployeeId, T1.LeaveRequestEndDate, T1.LeaveRequestStartDate, T2.LeaveTypeLoggingWorkHours, T2.LeaveTypeVacationLeave, T1.LeaveRequestStatus, T1.LeaveRequestDuration, T1.LeaveRequestHalfDay, T1.LeaveRequestDescription FROM (LeaveRequest T1 INNER JOIN LeaveType T2 ON T2.LeaveTypeId = T1.LeaveTypeId) WHERE (T1.EmployeeId = :EmployeeId) AND (T1.LeaveRequestStartDate < TO_DATE(:AV38Year||'-'||12||'-'||31, 'YYYY-MM-DD')) AND (T1.LeaveRequestEndDate > TO_DATE(:AV38Year||'-'||1||'-'||1, 'YYYY-MM-DD')) AND (T1.LeaveRequestStatus = ( 'Approved')) AND (T2.LeaveTypeVacationLeave = ( 'Yes')) AND (T2.LeaveTypeLoggingWorkHours = ( 'No')) ORDER BY T1.EmployeeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005E8,100, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("H005E9", "SELECT HolidayId, HolidayStartDate, HolidayIsActive, CompanyId, HolidayEndDate, HolidayName FROM Holiday WHERE (CompanyId = :AV36CompanyId) AND (date_part('year', HolidayStartDate) = :AV38Year) AND (HolidayStartDate >= :LeaveRequestStartDate) AND (HolidayStartDate <= :LeaveRequestEndDate) AND (HolidayIsActive = TRUE) ORDER BY CompanyId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005E9,100, GxCacheFrequency.OFF ,true,false )
        };
     }
  }
