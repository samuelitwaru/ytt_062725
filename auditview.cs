   ...
   public class auditview : GXDataArea
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV9AuditId = (long)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV9AuditId", StringUtil.LTrimStr( (decimal)(AV9AuditId), 10, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vAUDITID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9AuditId), "ZZZZZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("auditview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV9AuditId,10,0)),UrlEncode(StringUtil.RTrim(AV7TabCode))}, new string[] {"AuditId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vAUDITID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9AuditId), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vAUDITID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9AuditId), "ZZZZZZZZZ9"), context));
      ...
      {
         return formatLink("auditview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV9AuditId,10,0)),UrlEncode(StringUtil.RTrim(AV7TabCode))}, new string[] {"AuditId","TabCode"})  ;
      }
      ...
      protected void WB5Q0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Go to Audit", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_AuditView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_AuditView.htm");
            /* Div Control */
      ...
      protected void STRUP5Q0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV9AuditId = (long)(Math.Round(context.localUtil.CToN( cgiGet( "vAUDITID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E115Q2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("auditww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV13GXLvl9 = 0;
         /* Using cursor H005Q2 */
         pr_default.execute(0, new Object[] {AV9AuditId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A204AuditId = H005Q2_A204AuditId[0];
            A205AuditDate = H005Q2_A205AuditDate[0];
            AV13GXLvl9 = 1;
            Form.Caption = context.localUtil.DToC( A205AuditDate, 2, "/");
      ...
      protected void S112( )
      {
         ...
         if ( AV10LoadAllTabs || ( StringUtil.StrCmp(AV11SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV11SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "AuditGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "auditgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "AuditGeneral";
               WebComp_Generalwc_Component = "AuditGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0025",(string)"",(long)AV9AuditId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV9AuditId = Convert.ToInt64(getParm(obj,0));
         AssignAttri("", false, "AV9AuditId", StringUtil.LTrimStr( (decimal)(AV9AuditId), 10, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vAUDITID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9AuditId), "ZZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025991016432", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("auditview.js", "?2025991016432", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV9AuditId","fld":"vAUDITID","pic":"ZZZZZZZZZ9","hsh":true},{"av":"AV7TabCode","fld":"vTABCODE","hsh":true}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         H005Q2_A204AuditId = new long[1] ;
         H005Q2_A205AuditDate = new DateTime[] {DateTime.MinValue} ;
         A205AuditDate = DateTime.MinValue;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.auditview__default(),
            new Object[][] {
                new Object[] {
               H005Q2_A204AuditId, H005Q2_A205AuditDate
               }
            }
         );
      ...
      private int idxLst ;
      private long AV9AuditId ;
      private long wcpOAV9AuditId ;
      ...
      private long[] H005Q2_A204AuditId ;
      private DateTime[] H005Q2_A205AuditDate ;
   ...
   public class auditview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV9AuditId",GXType.Int64,10,0)
          };
          def= new CursorDef[] {
              new CursorDef("H005Q2", "SELECT AuditId, AuditDate FROM Audit WHERE AuditId = :AV9AuditId ORDER BY AuditId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005Q2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
