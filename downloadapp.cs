...
namespace GeneXus.Programs {
   public class downloadapp : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202618247575", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("downloadapp.js", "?202618247583", false, true);
            context.AddJavascriptSource("UserControls/DownloadAppJsRender.js", "", false, true);
         }
