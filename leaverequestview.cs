...
namespace GeneXus.Programs {
   public class leaverequestview : GXDataArea
   {
      ...
      protected void E11492( )
      {
         ...
         {
            A127LeaveRequestId = H00492_A127LeaveRequestId[0];
            A128LeaveRequestDate = H00492_A128LeaveRequestDate[0];
            AV16GXLvl9 = 1;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202571616154091", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("leaverequestview.js", "?202571616154091", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.leaverequestview__default(),
            new Object[][] {
                new Object[] {
               H00492_A127LeaveRequestId, H00492_A128LeaveRequestDate
               }
            }
         );
      ...
      private long[] H00492_A127LeaveRequestId ;
      private DateTime[] H00492_A128LeaveRequestDate ;
   ...
   public class leaverequestview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00492", "SELECT LeaveRequestId, LeaveRequestDate FROM LeaveRequest WHERE LeaveRequestId = :AV10LeaveRequestId ORDER BY LeaveRequestId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00492,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
