...
namespace GeneXus.Programs {
   public class trnnewww : GXDataArea
   {
      ...
      protected void RF5C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A40000TrnNewImage_GXI = H005C2_A40000TrnNewImage_GXI[0];
               AssignProp("", false, edtTrnNewImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A183TrnNewImage)) ? A40000TrnNewImage_GXI : context.convertURL( context.PathToRelativeUrl( A183TrnNewImage))), !bGXsfl_39_Refreshing);
               AssignProp("", false, edtTrnNewImage_Internalname, "SrcSet", context.GetImageSrcSet( A183TrnNewImage), true);
               A182TrnNewDate = H005C2_A182TrnNewDate[0];
               A181TrnNewName = H005C2_A181TrnNewName[0];
               A180TrnNewId = H005C2_A180TrnNewId[0];
               A183TrnNewImage = H005C2_A183TrnNewImage[0];
               AssignProp("", false, edtTrnNewImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A183TrnNewImage)) ? A40000TrnNewImage_GXI : context.convertURL( context.PathToRelativeUrl( A183TrnNewImage))), !bGXsfl_39_Refreshing);
               AssignProp("", false, edtTrnNewImage_Internalname, "SrcSet", context.GetImageSrcSet( A183TrnNewImage), true);
               /* Execute user event: Grid.Load */
               E205C2 ();
      ...
      protected void E185C2( )
      {
         ...
         AV47AGExportData = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTDropDownOptionsData_Item>( context, "Item", "");
         AV48AGExportDataItem = new WorkWithPlus.workwithplus_web.SdtDVB_SDTDropDownOptionsData_Item(context);
      ...
      protected void E195C2( )
      {
         ...
         edtTrnNewId_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV21ColumnsSelector.gxTpr_Columns.Item(1)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtTrnNewName_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV21ColumnsSelector.gxTpr_Columns.Item(2)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtTrnNewDate_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV21ColumnsSelector.gxTpr_Columns.Item(3)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtTrnNewImage_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV21ColumnsSelector.gxTpr_Columns.Item(4)).gxTpr_Isvisible ? 1 : 0);
      ...
      protected void E165C2( )
      {
         ...
         new WorkWithPlus.workwithplus_web.savecolumnsselectorstate(context ).execute(  "TrnNewWWColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV19ColumnsSelectorXML)) ? "" : AV21ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E115C2( )
      {
         ...
         else
         {
            ...
            new WorkWithPlus.workwithplus_web.getfilterbyname(context ).execute(  "TrnNewWWFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
            ...
            else
            {
               ...
               new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV52Pgmname+"GridState",  AV25ManageFiltersXml) ;
      ...
      protected void S172( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV21ColumnsSelector,  "TrnNewId",  "",  "New Id",  true,  "") ;
         new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV21ColumnsSelector,  "TrnNewName",  "",  "New Name",  true,  "") ;
         new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV21ColumnsSelector,  "TrnNewDate",  "",  "New Date",  true,  "") ;
         new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV21ColumnsSelector,  "TrnNewImage",  "",  "New Image",  true,  "") ;
         GXt_char2 = AV20UserCustomValue;
         new WorkWithPlus.workwithplus_web.loadcolumnsselectorstate(context ).execute(  "TrnNewWWColumnsSelector", out  GXt_char2) ;
      ...
      protected void S152( )
      {
         ...
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "trnnew_Update", out  GXt_boolean3) ;
         ...
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "trnnew_Delete", out  GXt_boolean3) ;
         ...
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "trnnew_Insert", out  GXt_boolean3) ;
      ...
      protected void S112( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_managefiltersloadsavedfilters(context ).execute(  "TrnNewWWFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S192( )
      {
         ...
         GXt_char2 = "";
         new WorkWithPlus.workwithplus_web.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV30TFTrnNewName_Sel)),  AV30TFTrnNewName_Sel, out  GXt_char2) ;
         Ddo_grid_Selectedvalue_set = "|"+GXt_char2+"||";
         ucDdo_grid.SendProperty(context, "", false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
         GXt_char2 = "";
         new WorkWithPlus.workwithplus_web.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV29TFTrnNewName)),  AV29TFTrnNewName, out  GXt_char2) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20257251412814", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trnnewww.js", "?20257251412818", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV52Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV27TFTrnNewId","fld":"vTFTRNNEWID","pic":"ZZZZZZZZZ9"},{"av":"AV28TFTrnNewId_To","fld":"vTFTRNNEWID_TO","pic":"ZZZZZZZZZ9"},{"av":"AV29TFTrnNewName","fld":"vTFTRNNEWNAME"},{"av":"AV30TFTrnNewName_Sel","fld":"vTFTRNNEWNAME_SEL"},{"av":"AV31TFTrnNewDate","fld":"vTFTRNNEWDATE"},{"av":"AV32TFTrnNewDate_To","fld":"vTFTRNNEWDATE_TO"},{"av":"AV44IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV46IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV49IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E205C2","iparms":[{"av":"AV44IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A180TrnNewId","fld":"TRNNEWID","pic":"ZZZZZZZZZ9","hsh":true},{"av":"AV46IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]""");
         ...
         setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","""{"handler":"E145C2","iparms":[{"av":"Ddo_agexport_Activeeventkey","ctrl":"DDO_AGEXPORT","prop":"ActiveEventKey"},{"av":"AV52Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV11GridState","fld":"vGRIDSTATE"},{"av":"AV30TFTrnNewName_Sel","fld":"vTFTRNNEWNAME_SEL"},{"av":"AV27TFTrnNewId","fld":"vTFTRNNEWID","pic":"ZZZZZZZZZ9"},{"av":"AV29TFTrnNewName","fld":"vTFTRNNEWNAME"},{"av":"AV31TFTrnNewDate","fld":"vTFTRNNEWDATE"},{"av":"AV28TFTrnNewId_To","fld":"vTFTRNNEWID_TO","pic":"ZZZZZZZZZ9"},{"av":"AV32TFTrnNewDate_To","fld":"vTFTRNNEWDATE_TO"}]""");
      ...
      public override void initialize( )
      {
         ...
         H005C2_A40000TrnNewImage_GXI = new string[] {""} ;
         H005C2_A182TrnNewDate = new DateTime[] {DateTime.MinValue} ;
         H005C2_A181TrnNewName = new string[] {""} ;
         H005C2_A180TrnNewId = new long[1] ;
         H005C2_A183TrnNewImage = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trnnewww__default(),
            new Object[][] {
                new Object[] {
               H005C2_A40000TrnNewImage_GXI, H005C2_A182TrnNewDate, H005C2_A181TrnNewName, H005C2_A180TrnNewId, H005C2_A183TrnNewImage
               }
               , new Object[] {
      ...
      private GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTDropDownOptionsData_Item> AV47AGExportData ;
      ...
      private string[] H005C2_A40000TrnNewImage_GXI ;
      private DateTime[] H005C2_A182TrnNewDate ;
      private string[] H005C2_A181TrnNewName ;
      private long[] H005C2_A180TrnNewId ;
      private string[] H005C2_A183TrnNewImage ;
      private long[] H005C3_AGRID_nRecordCount ;
      private WorkWithPlus.workwithplus_web.SdtDVB_SDTDropDownOptionsData_Item AV48AGExportDataItem ;
   ...
   public class trnnewww__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(TrnNewId,'9999999999'), 2) like '%' || :lV53Trnnewwwds_1_filterfulltext) or ( TrnNewName like '%' || :lV53Trnnewwwds_1_filterfulltext))");
         }
         else
         {
            GXv_int5[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         switch ( cursor )
         {
               ...
               case 1 :
                     return conditional_H005C3(context, (string)dynConstraints[0] , (long)dynConstraints[1] , (long)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (DateTime)dynConstraints[5] , (DateTime)dynConstraints[6] , (long)dynConstraints[7] , (string)dynConstraints[8] , (DateTime)dynConstraints[9] , (short)dynConstraints[10] , (bool)dynConstraints[11] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H005C2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005C2,1, GxCacheFrequency.OFF ,true,false )
