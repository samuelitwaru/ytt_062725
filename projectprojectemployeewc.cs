   ...
   public class projectprojectemployeewc : GXWebComponent
   {
      ...
      protected void RF512( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A106EmployeeId = H00512_A106EmployeeId[0];
               A102ProjectId = H00512_A102ProjectId[0];
               AssignAttri(sPrefix, false, "A102ProjectId", StringUtil.LTrimStr( (decimal)(A102ProjectId), 10, 0));
               A147EmployeeBalance = H00512_A147EmployeeBalance[0];
               A146EmployeeVactionDays = H00512_A146EmployeeVactionDays[0];
               A112EmployeeIsActive = H00512_A112EmployeeIsActive[0];
               A111GAMUserGUID = H00512_A111GAMUserGUID[0];
               A110EmployeeIsManager = H00512_A110EmployeeIsManager[0];
               A101CompanyName = H00512_A101CompanyName[0];
               A100CompanyId = H00512_A100CompanyId[0];
               A109EmployeeEmail = H00512_A109EmployeeEmail[0];
               A108EmployeeLastName = H00512_A108EmployeeLastName[0];
               A107EmployeeFirstName = H00512_A107EmployeeFirstName[0];
               A147EmployeeBalance = H00512_A147EmployeeBalance[0];
               A146EmployeeVactionDays = H00512_A146EmployeeVactionDays[0];
               A112EmployeeIsActive = H00512_A112EmployeeIsActive[0];
               A111GAMUserGUID = H00512_A111GAMUserGUID[0];
      ...
      protected void E17512( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_getappliedfiltersdescription(context ).execute(  AV32Pgmname, out  GXt_char2) ;
      ...
      protected void E11512( )
      {
         ...
         else
         {
            ...
            new WorkWithPlus.workwithplus_web.getfilterbyname(context ).execute(  "ProjectProjectEmployeeWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
            ...
            else
            {
               ...
               new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV32Pgmname+"GridState",  AV19ManageFiltersXml) ;
      ...
      protected void S112( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_managefiltersloadsavedfilters(context ).execute(  "ProjectProjectEmployeeWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S132( )
      {
         ...
         {
            AV12GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  AV32Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S182( )
      {
         ...
         {
            AV13GridStateFilterValue = ((WorkWithPlus.workwithplus_web.SdtWWPGridState_FilterValue)AV12GridState.gxTpr_Filtervalues.Item(AV33GXV1));
      ...
      protected void S162( )
      {
         ...
         new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV32Pgmname+"GridState",  AV12GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256267483484", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("projectprojectemployeewc.js", "?20256267483484", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E18512","iparms":[{"av":"AV28IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A106EmployeeId","fld":"EMPLOYEEID","pic":"ZZZZZZZZZ9","hsh":true},{"av":"AV30IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         A111GAMUserGUID = "";
         lV16FilterFullText = "";
         H00512_A106EmployeeId = new long[1] ;
         H00512_A102ProjectId = new long[1] ;
         H00512_A147EmployeeBalance = new decimal[1] ;
         H00512_A146EmployeeVactionDays = new decimal[1] ;
         H00512_A112EmployeeIsActive = new bool[] {false} ;
         H00512_A111GAMUserGUID = new string[] {""} ;
         H00512_A110EmployeeIsManager = new bool[] {false} ;
         H00512_A101CompanyName = new string[] {""} ;
         H00512_A100CompanyId = new long[1] ;
         H00512_A109EmployeeEmail = new string[] {""} ;
         H00512_A108EmployeeLastName = new string[] {""} ;
         H00512_A107EmployeeFirstName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.projectprojectemployeewc__default(),
            new Object[][] {
                new Object[] {
               H00512_A106EmployeeId, H00512_A102ProjectId, H00512_A147EmployeeBalance, H00512_A146EmployeeVactionDays, H00512_A112EmployeeIsActive, H00512_A111GAMUserGUID, H00512_A110EmployeeIsManager, H00512_A101CompanyName, H00512_A100CompanyId, H00512_A109EmployeeEmail,
               H00512_A108EmployeeLastName, H00512_A107EmployeeFirstName
               }
               , new Object[] {
      ...
      private long[] H00512_A106EmployeeId ;
      private long[] H00512_A102ProjectId ;
      private decimal[] H00512_A147EmployeeBalance ;
      private decimal[] H00512_A146EmployeeVactionDays ;
      private bool[] H00512_A112EmployeeIsActive ;
      private string[] H00512_A111GAMUserGUID ;
      private bool[] H00512_A110EmployeeIsManager ;
      private string[] H00512_A101CompanyName ;
      private long[] H00512_A100CompanyId ;
      private string[] H00512_A109EmployeeEmail ;
      private string[] H00512_A108EmployeeLastName ;
      private string[] H00512_A107EmployeeFirstName ;
   ...
   public class projectprojectemployeewc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00512", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00512,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00513", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00513,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
