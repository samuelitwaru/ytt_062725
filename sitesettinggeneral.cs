   ...
   public class sitesettinggeneral : GXWebComponent
   {
      ...
      protected void WB560( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Update", bttBtnupdate_Jsonclick, 7, "Update", "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11561_client"+"'", TempTags, "", 2, "HLP_SiteSettingGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Delete", bttBtndelete_Jsonclick, 7, "Delete", "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e12561_client"+"'", TempTags, "", 2, "HLP_SiteSettingGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF562( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A100CompanyId = H00562_A100CompanyId[0];
               A161IsLogHourOpen = H00562_A161IsLogHourOpen[0];
               AssignAttri(sPrefix, false, "A161IsLogHourOpen", A161IsLogHourOpen);
               A101CompanyName = H00562_A101CompanyName[0];
      ...
      protected void E14562( )
      {
         ...
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "sitesetting_Update", out  GXt_boolean1) ;
         ...
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "sitesetting_Delete", out  GXt_boolean1) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202572513523371", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("sitesettinggeneral.js", "?202572513523372", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOUPDATE'","""{"handler":"E11561","iparms":[{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A160SiteSettingId","fld":"SITESETTINGID","pic":"ZZZZZZZZZ9"}]""");
         setEventMetadata("'DOUPDATE'",""","oparms":[{"ctrl":"BTNUPDATE","prop":"Visible"}]}""");
         setEventMetadata("'DODELETE'","""{"handler":"E12561","iparms":[{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"A160SiteSettingId","fld":"SITESETTINGID","pic":"ZZZZZZZZZ9"}]""");
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         H00562_A100CompanyId = new long[1] ;
         H00562_A160SiteSettingId = new long[1] ;
         H00562_A161IsLogHourOpen = new bool[] {false} ;
         H00562_A101CompanyName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sitesettinggeneral__default(),
            new Object[][] {
                new Object[] {
               H00562_A100CompanyId, H00562_A160SiteSettingId, H00562_A161IsLogHourOpen, H00562_A101CompanyName
               }
            }
         );
         AV14Pgmname = "SiteSettingGeneral";
      ...
      private long[] H00562_A100CompanyId ;
      private long[] H00562_A160SiteSettingId ;
      private bool[] H00562_A161IsLogHourOpen ;
      private string[] H00562_A101CompanyName ;
   ...
   public class sitesettinggeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00562", "SELECT T1.CompanyId, T1.SiteSettingId, T1.IsLogHourOpen, T2.CompanyName FROM (SiteSetting T1 INNER JOIN Company T2 ON T2.CompanyId = T1.CompanyId) WHERE T1.SiteSettingId = :SiteSettingId ORDER BY T1.SiteSettingId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00562,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
