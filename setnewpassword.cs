...
namespace GeneXus.Programs {
   public class setnewpassword : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202571616161427", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("setnewpassword.js", "?202571616161430", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E124S2","iparms":[{"av":"AV45NewPassword","fld":"vNEWPASSWORD"},{"av":"AV46ConfirmPassword","fld":"vCONFIRMPASSWORD"},{"av":"AV44GamGuid","fld":"vGAMGUID","hsh":true}]}""");
         return  ;
      }
