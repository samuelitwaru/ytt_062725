...
namespace GeneXus.Programs {
   public class reportsdetail : GXWebComponent
   {
      ...
      protected void RF4M2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A100CompanyId = H004M2_A100CompanyId[0];
               A157CompanyLocationId = H004M2_A157CompanyLocationId[0];
               A106EmployeeId = H004M2_A106EmployeeId[0];
               A148EmployeeName = H004M2_A148EmployeeName[0];
               A157CompanyLocationId = H004M2_A157CompanyLocationId[0];
               /* Execute user event: Grid.Load */
               E144M2 ();
      ...
      protected void E134M2( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_getappliedfiltersdescription(context ).execute(  AV23Pgmname, out  GXt_char1) ;
      ...
      protected void S122( )
      {
         ...
         {
            AV11GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  AV23Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S132( )
      {
         ...
         new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV23Pgmname+"GridState",  AV11GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202572513502617", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("reportsdetail.js", "?202572513502617", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         H004M2_A100CompanyId = new long[1] ;
         H004M2_A157CompanyLocationId = new long[1] ;
         H004M2_A106EmployeeId = new long[1] ;
         H004M2_A148EmployeeName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportsdetail__default(),
            new Object[][] {
                new Object[] {
               H004M2_A100CompanyId, H004M2_A157CompanyLocationId, H004M2_A106EmployeeId, H004M2_A148EmployeeName
               }
               , new Object[] {
      ...
      private long[] H004M2_A100CompanyId ;
      private long[] H004M2_A157CompanyLocationId ;
      private long[] H004M2_A106EmployeeId ;
      private string[] H004M2_A148EmployeeName ;
   ...
   public class reportsdetail__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004M2(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (int)dynConstraints[2] );
               case 1 :
                     return conditional_H004M3(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (int)dynConstraints[2] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H004M2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004M2,100, GxCacheFrequency.OFF ,true,false )
