...
namespace GeneXus.Programs {
   public class gamotpauthentication : GXHttpHandler
   {
      ...
      protected void E11082( )
      {
         ...
         AV13User = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getusertootpauthentication(out  AV7AuthenticationTypeName, out  AV16UseTwoFactorAuthentication, out  AV28Errors);
         if ( AV28Errors.Count > 0 )
         {
         ...
         else
         {
            ...
            AV32GXV1 = 1;
            while ( AV32GXV1 <= AV28Errors.Count )
            {
               AV27Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV28Errors.Item(AV32GXV1));
               GX_msglist.addItem(AV27Error.gxTpr_Message);
      ...
      protected void E12082( )
      {
         ...
         if ( AV28Errors.Count == 0 )
         {
            ...
            AV11LoginOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).login(AV14UserName, AV15UserPassword, AV6AdditionalParameter, out  AV28Errors);
            if ( AV11LoginOK )
            {
            ...
            else
            {
               if ( AV28Errors.Count > 0 )
               {
                  if ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV28Errors.Item(1)).gxTpr_Code == 161 )
                  {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV33GXV2 = 1;
         while ( AV33GXV2 <= AV28Errors.Count )
         {
            AV27Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV28Errors.Item(AV33GXV2));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202572513524817", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamotpauthentication.js", "?202572513524821", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Mask/jquery.mask.js", "", false, true);
         context.AddJavascriptSource("DVelop/WorkWithPlusUtilities/BootstrapSelect.js", "", false, true);
         context.AddJavascriptSource("DVelop/WorkWithPlusUtilities/WorkWithPlusUtilitiesRender.js", "", false, true);
