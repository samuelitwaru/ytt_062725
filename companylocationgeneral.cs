   ...
   public class companylocationgeneral : GXWebComponent
   {
      ...
      protected void WB4F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Update", bttBtnupdate_Jsonclick, 7, "Update", "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e114f1_client"+"'", TempTags, "", 2, "HLP_CompanyLocationGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Delete", bttBtndelete_Jsonclick, 7, "Delete", "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e124f1_client"+"'", TempTags, "", 2, "HLP_CompanyLocationGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF4F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A159CompanyLocationCode = H004F2_A159CompanyLocationCode[0];
               AssignAttri(sPrefix, false, "A159CompanyLocationCode", A159CompanyLocationCode);
               A158CompanyLocationName = H004F2_A158CompanyLocationName[0];
      ...
      protected void E144F2( )
      {
         ...
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "companylocation_Update", out  GXt_boolean1) ;
         ...
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "companylocation_Delete", out  GXt_boolean1) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202572513523312", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("companylocationgeneral.js", "?202572513523312", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOUPDATE'","""{"handler":"E114F1","iparms":[{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A157CompanyLocationId","fld":"COMPANYLOCATIONID","pic":"ZZZZZZZZZ9"}]""");
         setEventMetadata("'DOUPDATE'",""","oparms":[{"ctrl":"BTNUPDATE","prop":"Visible"}]}""");
         setEventMetadata("'DODELETE'","""{"handler":"E124F1","iparms":[{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"A157CompanyLocationId","fld":"COMPANYLOCATIONID","pic":"ZZZZZZZZZ9"}]""");
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         H004F2_A157CompanyLocationId = new long[1] ;
         H004F2_A159CompanyLocationCode = new string[] {""} ;
         H004F2_A158CompanyLocationName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.companylocationgeneral__default(),
            new Object[][] {
                new Object[] {
               H004F2_A157CompanyLocationId, H004F2_A159CompanyLocationCode, H004F2_A158CompanyLocationName
               }
            }
         );
         AV14Pgmname = "CompanyLocationGeneral";
      ...
      private long[] H004F2_A157CompanyLocationId ;
      private string[] H004F2_A159CompanyLocationCode ;
      private string[] H004F2_A158CompanyLocationName ;
   ...
   public class companylocationgeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H004F2", "SELECT CompanyLocationId, CompanyLocationCode, CompanyLocationName FROM CompanyLocation WHERE CompanyLocationId = :CompanyLocationId ORDER BY CompanyLocationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004F2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
