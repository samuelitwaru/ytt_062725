...
namespace GeneXus.Programs {
   public class gamactivateuseraccount : GXDataArea
   {
      ...
      protected void E110E2( )
      {
         ...
         {
            AV41GXV1 = 1;
            while ( AV41GXV1 <= AV30Errors.Count )
            {
               AV29Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV30Errors.Item(AV41GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202572513525624", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamactivateuseraccount.js", "?202572513525628", false, true);
