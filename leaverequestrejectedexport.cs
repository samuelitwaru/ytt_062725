   ...
   public class leaverequestrejectedexport : GXProcedure
   {
      ...
      protected void S131( )
      {
         ...
         if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV54TFLeaveRequestHalfDay_Sel)) ) )
         {
            ...
            AV14CellRow = GXt_int2;
            GXt_char1 = "";
            new WorkWithPlus.workwithplus_web.wwp_export_securetext(context ).execute(  (String.IsNullOrEmpty(StringUtil.RTrim( AV54TFLeaveRequestHalfDay_Sel)) ? "(Empty)" : AV54TFLeaveRequestHalfDay_Sel), out  GXt_char1) ;
            AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
         }
         else
         {
            if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV53TFLeaveRequestHalfDay)) && (0==AV55TFLeaveRequestHalfDayOperator) ) )
            {
               ...
               {
                  GXt_char1 = "";
                  new WorkWithPlus.workwithplus_web.wwp_export_securetext(context ).execute(  AV53TFLeaveRequestHalfDay, out  GXt_char1) ;
                  AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
               }
      ...
      protected void S141( )
      {
         ...
         ((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV24ColumnsSelector.gxTpr_Columns.Item(8)).gxTpr_Isvisible = false;
      ...
      protected void S161( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A171LeaveRequestHalfDay = P00702_A171LeaveRequestHalfDay[0];
            n171LeaveRequestHalfDay = P00702_n171LeaveRequestHalfDay[0];
      ...
      protected void S151( )
      {
         ...
         new WorkWithPlus.workwithplus_web.loadcolumnsselectorstate(context ).execute(  "LeaveRequestRejectedColumnsSelector", out  GXt_char1) ;
      ...
      protected void S201( )
      {
         ...
         {
            AV22GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  "LeaveRequestRejectedGridState"), null, "", "");
         }
         else
         {
      ...
      public override void initialize( )
      {
         ...
         P00702_A171LeaveRequestHalfDay = new string[] {""} ;
         P00702_n171LeaveRequestHalfDay = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.leaverequestrejectedexport__default(),
            new Object[][] {
                new Object[] {
               P00702_A124LeaveTypeId, P00702_A106EmployeeId, P00702_A100CompanyId, P00702_A132LeaveRequestStatus, P00702_A147EmployeeBalance, P00702_A131LeaveRequestDuration, P00702_A130LeaveRequestEndDate, P00702_A129LeaveRequestStartDate, P00702_A171LeaveRequestHalfDay, P00702_n171LeaveRequestHalfDay,
      ...
      private string[] P00702_A171LeaveRequestHalfDay ;
      private bool[] P00702_n171LeaveRequestHalfDay ;
