   ...
   public class testprojectlogsbyemployee : GXDataArea
   {
      ...
      protected void E19552( )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV49QueryIntent)) )
         {
            ...
            {
               if ( new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context).executeUdp(  "workhourlog_Insert") )
               {
      ...
      private void E20552( )
      {
         ...
         if ( AV48RedirectToFirstDetail )
         {
            if ( StringUtil.StrCmp(AV49QueryIntent, "2") == 0 )
            {
               ...
               if ( new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context).executeUdp(  "workhourlogview_Execute") )
               {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025626756091", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("testprojectlogsbyemployee.js", "?2025626756092", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E20552","iparms":[{"av":"AV48RedirectToFirstDetail","fld":"vREDIRECTTOFIRSTDETAIL","hsh":true},{"av":"AV49QueryIntent","fld":"vQUERYINTENT","hsh":true},{"av":"AV44GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"A118WorkHourLogId","fld":"WORKHOURLOGID","pic":"ZZZZZZZZZ9","hsh":true}]""");
