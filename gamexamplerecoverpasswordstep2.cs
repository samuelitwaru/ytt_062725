...
namespace GeneXus.Programs {
   public class gamexamplerecoverpasswordstep2 : GXHttpHandler
   {
      ...
      protected void E120B2( )
      {
         ...
         {
            AV13User = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getuserbylogin(AV14UserAuthTypeName, AV15UserName, out  AV24GAMErrorCollection);
            if ( AV24GAMErrorCollection.Count == 0 )
            {
               AV6ChangePwdOK = AV13User.changepasswordbykey(AV10KeyToChangePassword, AV16UserPasswordNew, out  AV24GAMErrorCollection);
               if ( AV6ChangePwdOK )
               {
                  ...
                  AV11LoginOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).login(AV15UserName, AV16UserPasswordNew, AV5AdditionalParameter, out  AV24GAMErrorCollection);
                  if ( AV11LoginOK )
                  {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV26GXV1 = 1;
         while ( AV26GXV1 <= AV24GAMErrorCollection.Count )
         {
            AV23GAMError = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV24GAMErrorCollection.Item(AV26GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256241961020", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexamplerecoverpasswordstep2.js", "?20256241961022", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV24GAMErrorCollection = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError>( context, "GeneXus.Programs.genexussecurity.SdtGAMError", "GeneXus.Programs");
      ...
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError> AV24GAMErrorCollection ;
