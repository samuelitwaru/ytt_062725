...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void DeleteLeaveRequestAction( )
      {
         string cmdBuffer;
         try
         {
      ...
      private bool PreviousCheck( )
      {
         ...
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_table_not_exist", new   object[]  {"LeaveRequestAction"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "DeleteLeaveRequestAction" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_fileremove", new   object[]  {"LeaveRequestAction", ""}) );
      }
