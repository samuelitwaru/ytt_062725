   ...
   public class projectgeneral : GXWebComponent
   {
      ...
      protected void WB500( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Update", bttBtnupdate_Jsonclick, 7, "Update", "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11501_client"+"'", TempTags, "", 2, "HLP_ProjectGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Delete", bttBtndelete_Jsonclick, 7, "Delete", "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e12501_client"+"'", TempTags, "", 2, "HLP_ProjectGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF502( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A105ProjectStatus = H00502_A105ProjectStatus[0];
               AssignAttri(sPrefix, false, "A105ProjectStatus", A105ProjectStatus);
               A104ProjectDescription = H00502_A104ProjectDescription[0];
               AssignAttri(sPrefix, false, "A104ProjectDescription", A104ProjectDescription);
               A103ProjectName = H00502_A103ProjectName[0];
      ...
      protected void E14502( )
      {
         ...
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "project_Update", out  GXt_boolean2) ;
         ...
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "project_Delete", out  GXt_boolean2) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256275224276", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("projectgeneral.js", "?20256275224276", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOUPDATE'","""{"handler":"E11501","iparms":[{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A102ProjectId","fld":"PROJECTID","pic":"ZZZZZZZZZ9"}]""");
         setEventMetadata("'DOUPDATE'",""","oparms":[{"ctrl":"BTNUPDATE","prop":"Visible"}]}""");
         setEventMetadata("'DODELETE'","""{"handler":"E12501","iparms":[{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"A102ProjectId","fld":"PROJECTID","pic":"ZZZZZZZZZ9"}]""");
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         H00502_A102ProjectId = new long[1] ;
         H00502_A105ProjectStatus = new string[] {""} ;
         H00502_A104ProjectDescription = new string[] {""} ;
         H00502_A103ProjectName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.projectgeneral__default(),
            new Object[][] {
                new Object[] {
               H00502_A102ProjectId, H00502_A105ProjectStatus, H00502_A104ProjectDescription, H00502_A103ProjectName
               }
            }
         );
         AV18Pgmname = "ProjectGeneral";
      ...
      private long[] H00502_A102ProjectId ;
      private string[] H00502_A105ProjectStatus ;
      private string[] H00502_A104ProjectDescription ;
      private string[] H00502_A103ProjectName ;
   ...
   public class projectgeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00502", "SELECT ProjectId, ProjectStatus, ProjectDescription, ProjectName FROM Project WHERE ProjectId = :ProjectId ORDER BY ProjectId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00502,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
