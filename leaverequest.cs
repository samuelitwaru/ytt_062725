   ...
   public class leaverequest : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxJX_Action33") == 0 )
         {
            ...
            XC_33_0J21( A129LeaveRequestStartDate, A130LeaveRequestEndDate, A171LeaveRequestHalfDay, A106EmployeeId) ;
            return  ;
         }
      ...
      protected void DrawControls( )
      {
         ...
         /* ComboBox */
         GxWebStd.gx_combobox_ctrl1( context, dynavLeavetypeid, dynavLeavetypeid_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV45LeaveTypeId), 10, 0)), 1, dynavLeavetypeid_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, dynavLeavetypeid.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,31);\"", "", true, 0, "HLP_LeaveRequest.htm");
         dynavLeavetypeid.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV45LeaveTypeId), 10, 0));
         ...
         GxWebStd.gx_single_line_edit( context, edtavEmployeebalance_Internalname, StringUtil.LTrim( StringUtil.NToC( AV49EmployeeBalance, 4, 1, ".", "")), StringUtil.LTrim( ((edtavEmployeebalance_Enabled!=0) ? context.localUtil.Format( AV49EmployeeBalance, "Z9.9") : context.localUtil.Format( AV49EmployeeBalance, "Z9.9"))), TempTags+" onchange=\""+"gx.num.valid_decimal( this, ',','.','1');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, ',','.','1');"+";gx.evt.onblur(this,54);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavEmployeebalance_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavEmployeebalance_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_LeaveRequest.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               ajax_req_read_hidden_sdt(cgiGet( "vAUDITINGOBJECT"), AV50AuditingObject);
               AV51IsAvailable = StringUtil.StrToBool( cgiGet( "vISAVAILABLE"));
               ...
               A145LeaveTypeLoggingWorkHours = cgiGet( "LEAVETYPELOGGINGWORKHOURS");
               ...
               forbiddenHiddens.Add("Pgmname", StringUtil.RTrim( context.localUtil.Format( AV54Pgmname, "")));
               hsh = cgiGet( "hsh");
      ...
      protected void E110J2( )
      {
         ...
         if ( ( StringUtil.StrCmp(AV29TrnContext.gxTpr_Transactionname, AV54Pgmname) == 0 ) && ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) )
         {
            ...
            {
               AV30TrnContextAtt = ((WorkWithPlus.workwithplus_commonobjects.SdtWWPTransactionContext_Attribute)AV29TrnContext.gxTpr_Attributes.Item(AV55GXV1));
      ...
      protected void E120J2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.audittransaction(context ).execute(  AV50AuditingObject,  AV54Pgmname) ;
      ...
      protected void E160J2( )
      {
         ...
         AV47LeaveTypes.Sort("");
         AV56GXV2 = 1;
         while ( AV56GXV2 <= AV47LeaveTypes.Count )
         {
            AV46LeaveType = ((SdtSDTLeaveType)AV47LeaveTypes.Item(AV56GXV2));
      ...
      protected void Load0J21( )
      {
         ...
         if ( (pr_default.getStatus(4) != 101) )
         {
            ...
            A145LeaveTypeLoggingWorkHours = T000J6_A145LeaveTypeLoggingWorkHours[0];
      ...
      protected void CheckExtendedTable0J21( )
      {
         ...
         new prc_checkleavedateavailabilty(context ).execute(  A129LeaveRequestStartDate,  A130LeaveRequestEndDate, ref  A171LeaveRequestHalfDay, ref  A106EmployeeId, out  AV51IsAvailable) ;
         AssignAttri("", false, "A171LeaveRequestHalfDay", A171LeaveRequestHalfDay);
         AssignAttri("", false, "A106EmployeeId", StringUtil.LTrimStr( (decimal)(A106EmployeeId), 10, 0));
         AssignAttri("", false, "AV51IsAvailable", AV51IsAvailable);
         n171LeaveRequestHalfDay = (String.IsNullOrEmpty(StringUtil.RTrim( A171LeaveRequestHalfDay)) ? true : false);
         ...
         A145LeaveTypeLoggingWorkHours = T000J4_A145LeaveTypeLoggingWorkHours[0];
         pr_default.close(2);
      }
      ...
      protected void gxLoad_36( long A124LeaveTypeId )
      {
         ...
         A145LeaveTypeLoggingWorkHours = T000J8_A145LeaveTypeLoggingWorkHours[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
         AddString( "\""+GXUtil.EncodeJSConstant( StringUtil.RTrim( A125LeaveTypeName))+"\""+","+"\""+GXUtil.EncodeJSConstant( StringUtil.RTrim( A144LeaveTypeVacationLeave))+"\""+","+"\""+GXUtil.EncodeJSConstant( StringUtil.RTrim( A145LeaveTypeLoggingWorkHours))+"\"") ;
         AddString( "]") ;
         if ( (pr_default.getStatus(6) == 101) )
         {
            AddString( ",") ;
      ...
      protected void OnDeleteControls0J21( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            A145LeaveTypeLoggingWorkHours = T000J16_A145LeaveTypeLoggingWorkHours[0];
            pr_default.close(14);
            if ( StringUtil.StrCmp(A171LeaveRequestHalfDay, "") != 0 )
            {
               edtLeaveRequestEndDate_Enabled = 0;
      ...
      {
         /* Before Update Rules */
         new loadauditleaverequest(context ).execute(  "Y", ref  AV50AuditingObject,  A127LeaveRequestId,  Gx_mode) ;
      }
      ...
      protected void BeforeComplete0J21( )
      {
         ...
         if ( IsIns( )  )
         {
            new loadauditleaverequest(context ).execute(  "N", ref  AV50AuditingObject,  A127LeaveRequestId,  Gx_mode) ;
         }
         if ( IsUpd( )  )
         {
            new loadauditleaverequest(context ).execute(  "N", ref  AV50AuditingObject,  A127LeaveRequestId,  Gx_mode) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vAUDITINGOBJECT", AV50AuditingObject);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vAUDITINGOBJECT", AV50AuditingObject);
         }
         GxWebStd.gx_boolean_hidden_field( context, "vISAVAILABLE", AV51IsAvailable);
      ...
      protected void InitializeNonKey0J21( )
      {
         ...
         AV45LeaveTypeId = 0;
         AssignAttri("", false, "AV45LeaveTypeId", StringUtil.LTrimStr( (decimal)(AV45LeaveTypeId), 10, 0));
         AV50AuditingObject = new WorkWithPlus.workwithplus_web.SdtAuditingObject(context);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202631011385978", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("leaverequest.js", "?202631011385980", false, true);
      ...
      protected void XC_24_0J21( WorkWithPlus.workwithplus_web.SdtAuditingObject AV50AuditingObject ,
                                 ...
                                 string Gx_mode )
      {
         ...
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
         AddString( "\""+GXUtil.EncodeJSConstant( StringUtil.EncodeString( AV50AuditingObject.ToXml(false, true, "", "")))+"\"") ;
         AddString( "]") ;
         if ( true )
         {
            AddString( ",") ;
      ...
      protected void XC_25_0J21( WorkWithPlus.workwithplus_web.SdtAuditingObject AV50AuditingObject ,
                                 long A127LeaveRequestId ,
                                 string Gx_mode )
      {
         new loadauditleaverequest(context ).execute(  "Y", ref  AV50AuditingObject,  A127LeaveRequestId,  Gx_mode) ;
      ...
      protected void XC_26_0J21( string Gx_mode ,
                                 WorkWithPlus.workwithplus_web.SdtAuditingObject AV50AuditingObject ,
                                 long A127LeaveRequestId )
      {
         if ( IsIns( )  )
         {
      ...
      protected void XC_27_0J21( string Gx_mode ,
                                 WorkWithPlus.workwithplus_web.SdtAuditingObject AV50AuditingObject ,
                                 long A127LeaveRequestId )
      {
         if ( IsUpd( )  )
      ...
      protected void XC_33_0J21( DateTime A129LeaveRequestStartDate ,
                                 DateTime A130LeaveRequestEndDate ,
                                 string A171LeaveRequestHalfDay ,
                                 long A106EmployeeId )
      {
         ...
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
         AddString( "\""+GXUtil.EncodeJSConstant( StringUtil.RTrim( A171LeaveRequestHalfDay))+"\""+","+"\""+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A106EmployeeId), 10, 0, ".", "")))+"\""+","+"\""+GXUtil.EncodeJSConstant( StringUtil.BoolToStr( AV51IsAvailable))+"\"") ;
         AddString( "]") ;
         if ( true )
         {
            AddString( ",") ;
      ...
      public void Valid_Employeeid( )
      {
         ...
         if ( IsIns( )  && ! AV51IsAvailable )
         {
            GX_msglist.addItem(A148EmployeeName+" already has a leave request in this date range!", 1, "EMPLOYEEID");
            AnyError = 1;
            GX_FocusControl = edtEmployeeId_Internalname;
         }
         dynload_actions( ) ;
         ...
         AssignAttri("", false, "A171LeaveRequestHalfDay", StringUtil.RTrim( A171LeaveRequestHalfDay));
         radLeaveRequestHalfDay.CurrentValue = StringUtil.RTrim( A171LeaveRequestHalfDay);
         AssignProp("", false, radLeaveRequestHalfDay_Internalname, "Values", radLeaveRequestHalfDay.ToJavascriptSource(), true);
      ...
      public void Valid_Leavetypeid( )
      {
         ...
         A145LeaveTypeLoggingWorkHours = T000J21_A145LeaveTypeLoggingWorkHours[0];
         pr_default.close(19);
         dynload_actions( ) ;
         /*  Sending validation outputs */
         ...
         AssignAttri("", false, "A145LeaveTypeLoggingWorkHours", StringUtil.RTrim( A145LeaveTypeLoggingWorkHours));
      }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"Gx_mode","fld":"vMODE","pic":"@!","hsh":true},{"av":"AV29TrnContext","fld":"vTRNCONTEXT","hsh":true},{"av":"AV26LeaveRequestId","fld":"vLEAVEREQUESTID","pic":"ZZZZZZZZZ9","hsh":true},{"av":"A127LeaveRequestId","fld":"LEAVEREQUESTID","pic":"ZZZZZZZZZ9"},{"av":"AV54Pgmname","fld":"vPGMNAME"},{"av":"dynavEmployeeid"},{"av":"AV18EmployeeId","fld":"vEMPLOYEEID","pic":"ZZZZZZZZZ9"},{"av":"radLeaveRequestHalfDay"},{"av":"A171LeaveRequestHalfDay","fld":"LEAVEREQUESTHALFDAY"}]""");
         ...
         setEventMetadata("VALID_EMPLOYEEID","""{"handler":"Valid_Employeeid","iparms":[{"av":"Gx_mode","fld":"vMODE","pic":"@!","hsh":true},{"av":"A106EmployeeId","fld":"EMPLOYEEID","pic":"ZZZZZZZZZ9"},{"av":"A129LeaveRequestStartDate","fld":"LEAVEREQUESTSTARTDATE"},{"av":"A130LeaveRequestEndDate","fld":"LEAVEREQUESTENDDATE"},{"av":"A148EmployeeName","fld":"EMPLOYEENAME"},{"av":"AV51IsAvailable","fld":"vISAVAILABLE"},{"av":"AV44LeaveTypeCompanyId","fld":"vLEAVETYPECOMPANYID","pic":"ZZZZZZZZZ9"},{"av":"dynavLeavetypeid"},{"av":"AV45LeaveTypeId","fld":"vLEAVETYPEID","pic":"ZZZZZZZZZ9"},{"av":"A147EmployeeBalance","fld":"EMPLOYEEBALANCE","pic":"Z9.9"},{"av":"AV49EmployeeBalance","fld":"vEMPLOYEEBALANCE","pic":"Z9.9"},{"av":"dynavEmployeeid"},{"av":"AV18EmployeeId","fld":"vEMPLOYEEID","pic":"ZZZZZZZZZ9"},{"av":"radLeaveRequestHalfDay"},{"av":"A171LeaveRequestHalfDay","fld":"LEAVEREQUESTHALFDAY"}]""");
         setEventMetadata("VALID_EMPLOYEEID",""","oparms":[{"av":"A147EmployeeBalance","fld":"EMPLOYEEBALANCE","pic":"Z9.9"},{"av":"A148EmployeeName","fld":"EMPLOYEENAME"},{"av":"AV49EmployeeBalance","fld":"vEMPLOYEEBALANCE","pic":"Z9.9"},{"av":"A106EmployeeId","fld":"EMPLOYEEID","pic":"ZZZZZZZZZ9"},{"av":"AV51IsAvailable","fld":"vISAVAILABLE"},{"av":"dynavEmployeeid"},{"av":"AV18EmployeeId","fld":"vEMPLOYEEID","pic":"ZZZZZZZZZ9"},{"av":"radLeaveRequestHalfDay"},{"av":"A171LeaveRequestHalfDay","fld":"LEAVEREQUESTHALFDAY"}]}""");
         setEventMetadata("VALID_LEAVETYPEID","""{"handler":"Valid_Leavetypeid","iparms":[{"av":"A124LeaveTypeId","fld":"LEAVETYPEID","pic":"ZZZZZZZZZ9"},{"av":"AV44LeaveTypeCompanyId","fld":"vLEAVETYPECOMPANYID","pic":"ZZZZZZZZZ9"},{"av":"dynavLeavetypeid"},{"av":"AV45LeaveTypeId","fld":"vLEAVETYPEID","pic":"ZZZZZZZZZ9"},{"av":"A125LeaveTypeName","fld":"LEAVETYPENAME"},{"av":"A144LeaveTypeVacationLeave","fld":"LEAVETYPEVACATIONLEAVE"},{"av":"A145LeaveTypeLoggingWorkHours","fld":"LEAVETYPELOGGINGWORKHOURS"},{"av":"dynavEmployeeid"},{"av":"AV18EmployeeId","fld":"vEMPLOYEEID","pic":"ZZZZZZZZZ9"},{"av":"radLeaveRequestHalfDay"},{"av":"A171LeaveRequestHalfDay","fld":"LEAVEREQUESTHALFDAY"}]""");
         setEventMetadata("VALID_LEAVETYPEID",""","oparms":[{"av":"A125LeaveTypeName","fld":"LEAVETYPENAME"},{"av":"A144LeaveTypeVacationLeave","fld":"LEAVETYPEVACATIONLEAVE"},{"av":"A145LeaveTypeLoggingWorkHours","fld":"LEAVETYPELOGGINGWORKHOURS"},{"av":"dynavEmployeeid"},{"av":"AV18EmployeeId","fld":"vEMPLOYEEID","pic":"ZZZZZZZZZ9"},{"av":"radLeaveRequestHalfDay"},{"av":"A171LeaveRequestHalfDay","fld":"LEAVEREQUESTHALFDAY"}]}""");
      ...
      public override void initialize( )
      {
         ...
         T000J6_A145LeaveTypeLoggingWorkHours = new string[] {""} ;
         ...
         T000J4_A145LeaveTypeLoggingWorkHours = new string[] {""} ;
         ...
         T000J8_A145LeaveTypeLoggingWorkHours = new string[] {""} ;
         ...
         T000J16_A145LeaveTypeLoggingWorkHours = new string[] {""} ;
         ...
         T000J21_A145LeaveTypeLoggingWorkHours = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.leaverequest__default(),
            new Object[][] {
               ...
               , new Object[] {
               T000J4_A125LeaveTypeName, T000J4_A144LeaveTypeVacationLeave, T000J4_A145LeaveTypeLoggingWorkHours
               }
               , new Object[] {
               ...
               T000J6_A133LeaveRequestDescription, T000J6_A134LeaveRequestRejectionReason, T000J6_A148EmployeeName, T000J6_A144LeaveTypeVacationLeave, T000J6_A145LeaveTypeLoggingWorkHours, T000J6_A124LeaveTypeId, T000J6_A106EmployeeId
               }
               , new Object[] {
               T000J7_A147EmployeeBalance, T000J7_A148EmployeeName
               }
               , new Object[] {
               T000J8_A125LeaveTypeName, T000J8_A144LeaveTypeVacationLeave, T000J8_A145LeaveTypeLoggingWorkHours
               }
               , new Object[] {
               ...
               , new Object[] {
               T000J16_A125LeaveTypeName, T000J16_A144LeaveTypeVacationLeave, T000J16_A145LeaveTypeLoggingWorkHours
               }
               , new Object[] {
               ...
               , new Object[] {
               T000J21_A125LeaveTypeName, T000J21_A144LeaveTypeVacationLeave, T000J21_A145LeaveTypeLoggingWorkHours
               }
            }
         );
         AV54Pgmname = "LeaveRequest";
      ...
      private WorkWithPlus.workwithplus_web.SdtAuditingObject AV50AuditingObject ;
      ...
      private string[] T000J6_A145LeaveTypeLoggingWorkHours ;
      ...
      private string[] T000J4_A145LeaveTypeLoggingWorkHours ;
      ...
      private string[] T000J8_A145LeaveTypeLoggingWorkHours ;
      ...
      private string[] T000J16_A145LeaveTypeLoggingWorkHours ;
      ...
      private string[] T000J21_A145LeaveTypeLoggingWorkHours ;
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        def= new CursorDef[] {
           ...
           ,new CursorDef("T000J4", "SELECT LeaveTypeName, LeaveTypeVacationLeave, LeaveTypeLoggingWorkHours FROM LeaveType WHERE LeaveTypeId = :LeaveTypeId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000J4,1, GxCacheFrequency.OFF ,true,false )
           ...
           ,new CursorDef("T000J8", "SELECT LeaveTypeName, LeaveTypeVacationLeave, LeaveTypeLoggingWorkHours FROM LeaveType WHERE LeaveTypeId = :LeaveTypeId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000J8,1, GxCacheFrequency.OFF ,true,false )
           ...
           ,new CursorDef("T000J16", "SELECT LeaveTypeName, LeaveTypeVacationLeave, LeaveTypeLoggingWorkHours FROM LeaveType WHERE LeaveTypeId = :LeaveTypeId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000J16,1, GxCacheFrequency.OFF ,true,false )
           ...
           ,new CursorDef("T000J21", "SELECT LeaveTypeName, LeaveTypeVacationLeave, LeaveTypeLoggingWorkHours FROM LeaveType WHERE LeaveTypeId = :LeaveTypeId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000J21,1, GxCacheFrequency.OFF ,true,false )
        };
     }
  }
