...
namespace GeneXus.Programs {
   public class sitesettingview : GXDataArea
   {
      ...
      protected void E11572( )
      {
         ...
         {
            A160SiteSettingId = H00572_A160SiteSettingId[0];
            A161IsLogHourOpen = H00572_A161IsLogHourOpen[0];
            AV16GXLvl9 = 1;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202571616162240", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("sitesettingview.js", "?202571616162241", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         H00572_A160SiteSettingId = new long[1] ;
         H00572_A161IsLogHourOpen = new bool[] {false} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sitesettingview__default(),
            new Object[][] {
                new Object[] {
               H00572_A160SiteSettingId, H00572_A161IsLogHourOpen
               }
            }
         );
      ...
      private long[] H00572_A160SiteSettingId ;
      private bool[] H00572_A161IsLogHourOpen ;
   ...
   public class sitesettingview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00572", "SELECT SiteSettingId, IsLogHourOpen FROM SiteSetting WHERE SiteSettingId = :AV10SiteSettingId ORDER BY SiteSettingId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00572,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
