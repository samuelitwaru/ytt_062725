   ...
   public class leavetypeleaverequestwc : GXWebComponent
   {
      ...
      protected void RF2R2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               ...
               A171LeaveRequestHalfDay = H002R2_A171LeaveRequestHalfDay[0];
               n171LeaveRequestHalfDay = H002R2_n171LeaveRequestHalfDay[0];
      ...
      protected void E112R2( )
      {
         ...
         else
         {
            ...
            new WorkWithPlus.workwithplus_web.getfilterbyname(context ).execute(  "LeaveTypeLeaveRequestWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
      ...
      protected void S112( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_managefiltersloadsavedfilters(context ).execute(  "LeaveTypeLeaveRequestWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202572513515341", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("leavetypeleaverequestwc.js", "?202572513515342", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         H002R2_A171LeaveRequestHalfDay = new string[] {""} ;
         H002R2_n171LeaveRequestHalfDay = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.leavetypeleaverequestwc__default(),
            new Object[][] {
                new Object[] {
               H002R2_A124LeaveTypeId, H002R2_A106EmployeeId, H002R2_A134LeaveRequestRejectionReason, H002R2_A133LeaveRequestDescription, H002R2_A132LeaveRequestStatus, H002R2_A131LeaveRequestDuration, H002R2_A171LeaveRequestHalfDay, H002R2_n171LeaveRequestHalfDay, H002R2_A130LeaveRequestEndDate, H002R2_A129LeaveRequestStartDate,
      ...
      private string[] H002R2_A171LeaveRequestHalfDay ;
      private bool[] H002R2_n171LeaveRequestHalfDay ;
