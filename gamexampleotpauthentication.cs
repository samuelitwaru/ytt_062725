...
namespace GeneXus.Programs {
   public class gamexampleotpauthentication : GXHttpHandler
   {
      ...
      protected void E11082( )
      {
         /* Start Routine */
         returnInSub = false;
         AV13User = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getusertootpauthentication(out  AV7AuthenticationTypeName, out  AV16UseTwoFactorAuthentication, out  AV24GAMErrorCollection);
         ...
         {
            AV25GAMAuthenticationTypeSimple = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getenabledauthenticationtypebyname(AV7AuthenticationTypeName, AV26Language, out  AV24GAMErrorCollection);
            if ( ! AV25GAMAuthenticationTypeSimple.gxTpr_Istotp && ! AV25GAMAuthenticationTypeSimple.gxTpr_Twofactorauthentication_istotp )
            {
      ...
      protected void E12082( )
      {
         ...
         if ( AV24GAMErrorCollection.Count == 0 )
         {
            ...
            AV11LoginOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).login(AV14UserName, AV15UserPassword, AV6AdditionalParameter, out  AV24GAMErrorCollection);
            if ( AV11LoginOK )
            {
            ...
            else
            {
               if ( AV24GAMErrorCollection.Count > 0 )
               {
                  if ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV24GAMErrorCollection.Item(1)).gxTpr_Code == 161 )
                  {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV27GXV1 = 1;
         while ( AV27GXV1 <= AV24GAMErrorCollection.Count )
         {
            AV23GAMError = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV24GAMErrorCollection.Item(AV27GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256246585229", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexampleotpauthentication.js", "?20256246585232", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV25GAMAuthenticationTypeSimple = new GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple(context);
         AV26Language = "";
      ...
      private GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple AV25GAMAuthenticationTypeSimple ;
