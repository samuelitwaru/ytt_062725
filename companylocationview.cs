...
namespace GeneXus.Programs {
   public class companylocationview : GXDataArea
   {
      ...
      protected void E114D2( )
      {
         ...
         {
            A157CompanyLocationId = H004D2_A157CompanyLocationId[0];
            A158CompanyLocationName = H004D2_A158CompanyLocationName[0];
            AV16GXLvl9 = 1;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202571616154048", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("companylocationview.js", "?202571616154048", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.companylocationview__default(),
            new Object[][] {
                new Object[] {
               H004D2_A157CompanyLocationId, H004D2_A158CompanyLocationName
               }
            }
         );
      ...
      private long[] H004D2_A157CompanyLocationId ;
      private string[] H004D2_A158CompanyLocationName ;
   ...
   public class companylocationview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H004D2", "SELECT CompanyLocationId, CompanyLocationName FROM CompanyLocation WHERE CompanyLocationId = :AV10CompanyLocationId ORDER BY CompanyLocationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004D2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
